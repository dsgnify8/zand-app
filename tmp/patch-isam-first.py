# Isam, first.
#
# TPM's cover star for that issue, and first position is a `big` slot in
# the feed rhythm — full width, cover across the top. That is the right
# shape for a cover star.
#
# Anchored on the piece that currently sits first rather than inserted by
# index. Counting object boundaries in this file has now gone wrong twice.
#
# Fixed: a lowercase sentence start, and "the first Iranian rappers" where
# it should be singular. Numbered questions lose their numbers, as with
# the other Q&A pieces.

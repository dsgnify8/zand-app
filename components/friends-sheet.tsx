...
const s = StyleSheet.create({
  ...
  sheet: { maxHeight: '88%', backgroundColor: colors.background, borderTopLeftRadius: 22, borderTopRightRadius: 22, paddingHorizontal: spacing.lg, paddingTop: spacing.sm, maxHeight: '85%' },

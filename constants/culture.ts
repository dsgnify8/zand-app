...
export const CULTURE_PAGES: Record<string, CuPage[]> = {
  ...
  taarof: [
    { key: 't1', nav: 'The Dance', navFa: 'رقص', title: 'The Offer You Must Refuse', titleFa: 'تعارفی که باید رد کنی', eyebrow: 'WHAT TAAROF IS',
      blocks: [
        ...
        { t: 'p', x: 'To an outsider it looks like lying. It is closer to the opposite. It is a system for protecting people from ever having to be humiliated by a direct no.', fa: 'برای کسی که از بیرون به ماجرا نگاه می‌کند، ممکن است شبیه دروغ گفتن به نظر برسد. اما در واقع، درست برعکس است. تعارف روشی است برای اینکه هیچ‌کس مجبور نشود با شنیدن یک «نه» مستقیم، احساس خجالت یا شرمندگی کند.' },
        { t: 'taarofsim' },
      ] },
    { key: 't2', nav: 'The Rules', navFa: 'قاعده‌ها', title: 'Three Times', titleFa: 'سه بار', eyebrow: 'HOW IT WORKS',
      blocks: [
        ...
        { t: 'steps', items: [
          { n: 'The first offer', nFa: 'تعارف اول', x: 'Almost always empty. It is politeness. Take it and you have misread the room.', fa: 'تقریباً همیشه فقط یک تعارفِ توخالی است؛ نشانه‌ای از ادب و احترام. اگر همان بار اول قبولش کنی، یعنی حال‌وهوای جمع را درست متوجه نشده‌ای.' },
          { n: 'The second offer', nFa: 'تعارف دوم', x: 'Getting warmer. Still refuse. This is where the other person shows they meant it.', fa: 'دارد جدی‌تر می‌شود. اما هنوز باید ردش کنی. اینجاست که طرف مقابل نشان می‌دهد که پیشنهادش واقعاً از روی قصد بوده است.' },
          { n: 'The third offer', nFa: 'تعارف سوم', x: 'Now it is real. Now you may accept, and everyone is satisfied, and nobody was ever exposed.', fa: 'حالا دیگر پیشنهاد واقعی است. حالا می‌توانی قبولش کنی؛ همه راضی‌اند و هیچ‌کس هم در موقعیتی قرار نگرفته که احساس شرمندگی یا خجالت کند.' },
        ] },
        { t: 'mark', x: 'The rule of three exists so that nobody ever has to hear a real no.', fa: 'قانونِ سه بار وجود دارد تا هیچ‌کس مجبور نشود یک «نه» واقعی و مستقیم بشنود.' },
    ...
    { key: 't3', nav: 'The Cost', navFa: 'هزینه', title: 'What It Is For', titleFa: 'تعارف برای چیست؟', eyebrow: 'AND WHAT IT COSTS',
      blocks: [
        ...
        { t: 'aside', x: 'This is the thing most Iranians abroad say they get wrong with their own relatives.', fa: 'بیشتر ایرانی‌های خارج از کشور می‌گویند همین چیزی است که با فامیل خودشان اشتباه انجامش می‌دهند.' },
        { t: 'close', x: 'It is not dishonesty. It is a language in which the words are not the message and everybody fluent knows it. The only people it fools are the ones taking it literally.', fa: 'این نادرستی و دورویی نیست. زبانی است که در آن، خودِ کلمه‌ها پیام نیستند، و هر کسی که به این زبان مسلط باشد این را می‌داند. تنها کسانی را گول می‌زند که آن را عیناً و تحت‌اللفظی می‌گیرند.' },
      ] },
  ],

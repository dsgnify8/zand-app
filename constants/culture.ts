  ...
  taarof: [
    ...
    { key: 't2', nav: 'The Rules', navFa: 'قاعده‌ها', title: 'Three Times', titleFa: 'سه بار', eyebrow: 'HOW IT WORKS',
      blocks: [
        ...
        { t: 'steps', items: [
          { n: 'The first offer', nFa: 'تعارف اول', x: 'Almost always empty. It is politeness. Take it and you have misread the room.', fa: 'تقریباً همیشه پشتش خالی است. فقط ادب است. اگر قبولش کنی، یعنی فضا را درست نخوانده‌ای.' },
          { n: 'The second offer', nFa: 'تعارف دوم', x: 'Getting warmer. Still refuse. This is where the other person shows they meant it.', fa: 'کم‌کم دارد جدی می‌شود. باز هم رد کن. اینجاست که طرف مقابل نشان می‌دهد واقعاً منظوری داشته.' },
          { n: 'The third offer', nFa: 'تعارف سوم', x: 'Now it is real. Now you may accept, and everyone is satisfied, and nobody was ever exposed.', fa: 'حالا دیگر واقعی است. حالا می‌توانی قبول کنی؛ همه راضی‌اند، و آبروی هیچ‌کس هم نرفت.' },
        ] },
        { t: 'mark', x: 'The rule of three exists so that nobody ever has to hear a real no.', fa: 'قانون سه بار برای این وجود دارد که هیچ‌کس هرگز مجبور نشود یک «نهِ» واقعی بشنود.' },
    ...
    { key: 't3', nav: 'The Cost', navFa: 'هزینه', title: 'What It Is For', titleFa: 'به چه درد می‌خورد', eyebrow: 'AND WHAT IT COSTS',
      blocks: [

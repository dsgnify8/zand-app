...
export const CULTURE_TOPICS: CultureTopic[] = [
  ...
  { key: 'mehmun', title: 'The Guest', titleFa: 'مهمان', persian: 'مهمان', tag: 'HOSPITALITY AS COMBAT', tagFa: 'مهمان‌نوازی در قامت نبرد', blurb: 'The guest is beloved of God, and you will be fed until you suffer, and you are not permitted to leave.', blurbFa: 'مهمان حبیب خداست؛ آن‌قدر به تو غذا می‌دهند تا دیگر از خوردن به زحمت بیفتی، و اجازهٔ رفتن هم نداری.', accent: '#C4808B', glyph: 'home' },
  { key: 'javanmardi', title: 'Javanmardi', titleFa: 'جوانمردی', persian: 'جوانمردی', tag: 'THE HOUSE OF STRENGTH', tagFa: 'خانهٔ زور', blurb: 'A thousand year old code of chivalry, and a pit where men swing clubs while a drummer chants Ferdowsi at them.', blurbFa: 'مرامی هزارساله، و گودی که در آن مردها میل می‌چرخانند و مرشد با ضرب گرفتن، اشعار فردوسی را برایشان می‌خواند.', accent: '#8FA86B', glyph: 'shield' },
  { key: 'sofreh', title: 'The Table', titleFa: 'سفره', persian: 'سفره', tag: 'FOOD, AND WHAT IT MEANS', tagFa: 'غذا، و معنایی که با خود دارد', blurb: 'Rice is not a side dish. The crust at the bottom of the pot is fought over. Nobody eats alone if it can be helped.', blurbFa: 'برنج غذای فرعی نیست. سرِ ته‌دیگ رقابت است. و تا جایی که بشود، هیچ‌کس تنها غذا نمی‌خورد.', accent: '#4E9AA0', glyph: 'restaurant' },
  { key: 'chai', title: 'Chai', titleFa: 'چای', persian: 'چای', tag: 'THE SHAPE OF AN EVENING', tagFa: 'شکلِ یک عصر', blurb: 'The samovar, the small glass, the sugar cube held in the teeth. Never a drink. Always an occasion.', blurbFa: 'سماور، استکان کمرباریک، و حبه‌قندی که لای دندان نگه داشته می‌شود. هیچ‌وقت فقط یک نوشیدنی نیست؛ همیشه بهانه‌ای برای یک دورهمی است.', accent: '#D9A94C', glyph: 'cafe' },
  { key: 'typical', title: 'Typical Persian', titleFa: 'ایرانیِ اصیل', persian: 'ایرانی', tag: 'YOU KNOW THE ONES', tagFa: 'خودت می‌دانی کدام‌ها را می‌گویم', blurb: 'Persian Standard Time. The gold at birth. The forty minute goodbye at the door. Tap a card and find the truth underneath the joke.', blurbFa: 'وقتِ ایرانی. طلایی که از همان بدو تولد نصیبت می‌شود. خداحافظیِ چهل‌دقیقه‌ای دمِ در. روی هر کارت بزن و حقیقتِ پشتِ شوخی را پیدا کن.', accent: '#4E9AA0', glyph: 'happy' },
];
...
export const CULTURE_PAGES: Record<string, CuPage[]> = {
  ...
  mehmun: [
    { key: 'm1', nav: 'The Guest', navFa: 'مهمان', title: 'Beloved of God', titleFa: 'حبیب خدا', eyebrow: 'مهمان',
      blocks: [
        { t: 'lead', x: 'The guest is beloved of God. This is not a saying. It is an instruction, and it will be carried out.', fa: 'مهمان حبیب خداست. این فقط یک حرف نیست؛ یک دستور است و به آن عمل خواهد شد.' },
    ...
    { key: 'm2', nav: 'The Siege', navFa: 'محاصره', title: 'You Are Not Leaving', titleFa: 'اجازهٔ رفتن نداری', eyebrow: 'HOW IT GOES',
      blocks: [
        { t: 'steps', items: [
          { n: 'You arrive', nFa: 'می‌رسی', x: 'Shoes off at the door, always, without discussion. Tea appears before you have sat down. Fruit is cut, whether or not anyone wants fruit.', fa: 'کفش‌ها را دم در درمی‌آوری، همیشه، بی‌هیچ بحثی. هنوز ننشسته‌ای که چای از راه می‌رسد. میوه را هم می‌برند، چه کسی میوه بخواهد و چه نخواهد.' },
          { n: 'You are fed', x: 'More than anyone could eat. If you clear your plate it means you were not given enough, and it is refilled. If you leave food, you are asked what is wrong with it. There is no correct move.', fa: 'بیشتر از چیزی که یک نفر بتواند بخورد. اگر بشقابت را کامل خالی کنی، یعنی به تو کم داده‌اند و دوباره پرش می‌کنند. اگر غذا را باقی بگذاری، می‌پرسند مگر چه ایرادی داشت. هیچ راه درستی برای این کار وجود ندارد.' },
          { n: 'You say you are full', x: 'This is heard as taarof and dismissed. You will be served again. Say it three times and possibly, possibly, you will be believed.', fa: 'حرفت را تعارف حساب می‌کنند و نادیده می‌گیرند. باز هم برایت غذا می‌کشند. سه بار که بگویی، شاید، فقط شاید، باورت کنند.' },
          { n: 'You try to leave', x: 'This takes forty minutes. You stand. You are told to sit. You reach the hallway. A conversation begins in the hallway. You reach the door. A new conversation begins at the door.', fa: 'این مرحله چهل دقیقه طول می‌کشد. بلند می‌شوی. می‌گویند بنشین. به راهرو می‌رسی و گفت‌وگویی در راهرو شروع می‌شود. به در می‌رسی و گفت‌وگوی تازه‌ای دم در آغاز می‌شود.' },
          { n: 'You reach the car', x: 'Someone comes out with food for you to take home. This is not optional either.', fa: 'یکی با ظرف غذایی می‌آید تا با خودت به خانه ببری. این یکی هم اختیاری نیست.' },
        ] },
        { t: 'mark', x: 'The Persian goodbye is not the end of the visit. It is a distinct event, and it is longer than most meetings.', fa: 'خداحافظی ایرانی پایان مهمانی نیست. خودش یک مراسم جداگانه است و از خیلی از دیدارها هم طولانی‌تر است.' },
      ] },
    { key: 'm3', nav: 'Why', navFa: 'چرا', title: 'What Is Actually Happening', titleFa: 'در واقع چه خبر است؟', eyebrow: 'UNDERNEATH IT',
      blocks: [
        ...
        { t: 'p', x: 'And some of it is simpler. Feeding people is how affection is expressed in a culture where saying it outright is difficult. The plate that keeps being refilled is a sentence that nobody in the room is able to say.', fa: 'و بخشی از ماجرا ساده‌تر است. در فرهنگی که ابراز مستقیم محبت دشوار است، غذا دادن راهی برای نشان دادن محبت است. آن بشقابی که مدام دوباره پر می‌شود، جمله‌ای است که هیچ‌کس در آن اتاق نمی‌تواند به زبان بیاورد.' },
        { t: 'aside', x: 'This is why Persian mothers send you home with food. It is not about the food.', fa: 'برای همین است که مادرهای ایرانی موقع رفتن ظرف غذا دستت می‌دهند. ماجرا اصلاً خودِ غذا نیست.' },
        { t: 'p', x: 'And look at what all of it is actually doing. Eat more. Take this. Sit down. Stay a little longer. It is called friendliness, and it is not friendliness. It is a refusal to let anyone be alone in our presence, carried out by force if necessary.', fa: 'و ببین همهٔ این کارها در واقع چه می‌گویند: بیشتر بخور. این را بردار. بنشین. کمی دیگر بمان. اسمش را می‌گذارند خوش‌برخوردی، اما فقط خوش‌برخوردی نیست. این یعنی ما حاضر نیستیم بگذاریم کسی در حضور ما احساس تنهایی کند؛ حتی اگر لازم باشد، به زور.' },
        { t: 'mark', x: 'It is not that Iranians are welcoming. It is that we will not permit you to be lonely in front of us.', fa: 'مسئله این نیست که ایرانی‌ها فقط مهمان‌نوازند. مسئله این است که ما اجازه نمی‌دهیم جلوی چشم ما احساس تنهایی کنی.' },
        { t: 'close', x: 'You will be fed until you suffer, kept at the door for forty minutes, and sent home with a bag you did not ask for. All of it is one message, delivered in the only vocabulary available.', fa: 'آن‌قدر به تو غذا می‌دهند تا از خوردن به زحمت بیفتی، چهل دقیقه دم در نگهت می‌دارند و با کیسه‌ای که اصلاً نخواسته بودی راهی خانه‌ات می‌کنند. همهٔ اینها یک پیام است، با تنها زبانی که برای بیانش در اختیار داریم.' },
      ] },
  ],
  ...
  javanmardi: [
    { key: 'j1', nav: 'The Code', navFa: 'مرام', title: 'The Young Man Way', titleFa: 'راه و رسم جوانمردی', eyebrow: 'جوانمردی',
      blocks: [
        { t: 'lead', x: 'Persian chivalry. A thousand years old, still the highest compliment you can pay a man in Iran, and almost unknown outside it.', fa: 'جوانمردی ایرانی. هزار سال قدمت دارد، هنوز بالاترین تعریفی است که می‌توان از یک مرد در ایران کرد، و بیرون از ایران تقریباً ناشناخته است.' },
    ...
    { key: 'j2', nav: 'The Pit', navFa: 'گود', title: 'The House of Strength', titleFa: 'خانهٔ زور', eyebrow: 'ZURKHANEH',
      blocks: [
        { t: 'p', x: 'And then there is the building. The zurkhaneh, the house of strength, is one of the strangest and best institutions Iran has produced, and it is roughly a thousand years old.', fa: 'و بعد، خودِ ساختمان. زورخانه، یعنی خانهٔ زور، یکی از عجیب‌ترین و در عین حال ارزشمندترین نهادهایی است که ایران پدید آورده و حدود هزار سال قدمت دارد.' },
        { t: 'p', x: 'It is a low domed room with a pit in the middle, sunk below the floor, so that everyone who enters must step down. Men train in that pit. They swing enormous wooden clubs, they lift a wooden shield, they turn in place, they wrestle.', fa: 'اتاقی با گنبدی کوتاه است و گودی‌ای در وسط آن که پایین‌تر از کف قرار گرفته، طوری که هر کس وارد می‌شود باید چند پله پایین برود. مردها در همان گود تمرین می‌کنند؛ میل‌های چوبی بزرگ را می‌چرخانند، سنگ‌های زورخانه را بلند می‌کنند، در جای خود می‌چرخند و کشتی می‌گیرند.' },
        { t: 'zurkhaneh' },
        { t: 'h', x: 'The drum and the poem', fa: 'ضرب و شعر' },
        { t: 'p', x: 'And here is the part nobody expects. In a raised seat at the edge sits the morshed, the master, with a goblet drum and a bell. He drums the rhythm the men move to, and while he drums, he chants. He chants Ferdowsi. He chants Hafez and Rumi and Saadi.', fa: 'و حالا می‌رسیم به آن بخشی که هیچ‌کس انتظارش را ندارد. بر سکویی بلند در کنار گود، مرشد نشسته است؛ با یک ضرب و یک زنگ. ریتمی می‌گیرد که مردها با آن حرکت می‌کنند و هم‌زمان با ضرب گرفتن، آواز می‌خواند. از فردوسی می‌خواند؛ از حافظ و مولانا و سعدی.' },
        { t: 'mark', x: 'It is a gym where the poetry is played over the sound system, live, by a man with a drum, and the poetry is eight hundred years old.', fa: 'باشگاهی است که در آن شعر زنده، با ضرب گرفتنِ مردی که آن را می‌خواند، در فضا طنین می‌اندازد؛ و خودِ آن شعر هشتصد سال قدمت دارد.' },
        { t: 'p', x: 'So the men in the pit are not only training. They are being told, in rhythm, in verse, what a man is for. The physical culture and the ethical culture and the literature are the same activity, in the same room, at the same time. Nothing else in the world quite works like this.', fa: 'پس مردهایی که در گود هستند فقط تمرین نمی‌کنند. با ریتم و شعر به آنها یادآوری می‌شود که مرد بودن یعنی چه و چه معنایی دارد. پرورش تن، پرورش اخلاق و ادبیات، همه یک کارند؛ در یک اتاق و در یک زمان. در هیچ جای دیگری از دنیا چیزی دقیقاً شبیه این وجود ندارد.' },
        { t: 'aside', x: 'The pit is sunk below floor level for a reason. You step down to enter. Nobody stands above anybody.', fa: 'گود را عمداً پایین‌تر از سطح زمین ساخته‌اند. برای وارد شدن باید پایین بروی. اینجا هیچ‌کس بالاتر از دیگری نمی‌ایستد.' },
      ] },
    { key: 'j3', nav: 'Takhti', navFa: 'تختی', title: 'The Man They Loved', titleFa: 'مردی که دوستش داشتند', eyebrow: 'THE MODERN SAINT',
      blocks: [
        { t: 'p', x: 'If you want to know what Iranians mean by javanmard, they will not explain. They will tell you about Takhti.', fa: 'اگر می‌خواهی بدانی ایرانی‌ها از جوانمرد چه می‌فهمند، برایت توضیح نمی‌دهند؛ از تختی برایت می‌گویند.' },
        { t: 'p', x: 'Gholamreza Takhti was a wrestler, an Olympic champion, and the most beloved athlete in Iranian history. But that is not why he is beloved. The stories are all about the same thing.', fa: 'غلامرضا تختی کشتی‌گیر و قهرمان المپیک بود و محبوب‌ترین ورزشکار تاریخ ایران به شمار می‌رفت. اما دلیل محبوبیتش اینها نیست. همهٔ داستان‌هایی که درباره‌اش مانده، به یک چیز برمی‌گردند.' },
        { t: 'story', title: 'The Injured Leg', titleFa: 'آن پای آسیب‌دیده', x: 'Wrestling a Russian opponent who had an injured right leg, Takhti did not touch it once. He wrestled the man honestly, on his strength, and won without exploiting the injury. The opponent mother is said to have kissed him afterward.', fa: 'در مسابقه با حریفی روس که پای راستش آسیب دیده بود، تختی حتی یک بار هم سراغ آن پا نرفت. مردانه و جوانمردانه، با تکیه بر توان خودش کشتی گرفت و بدون سوءاستفاده از آسیب حریف پیروز شد. می‌گویند مادر آن حریف بعد از مسابقه او را بوسید.', moral: 'He could have won faster. He would rather have won properly.' },
        { t: 'p', x: 'And when an earthquake destroyed a town, Takhti went into the streets of Tehran with a collection tin himself, in person, and people gave him everything they had because it was him. He died in 1968, and the circumstances are still argued about, and his funeral filled the city.', fa: 'و وقتی زلزله‌ای شهری را ویران کرد، تختی خودش، شخصاً، با صندوق جمع‌آوری کمک به خیابان‌های تهران رفت؛ و مردم هرچه داشتند به او دادند، فقط چون تختی بود. او در سال ۱۳۴۶ درگذشت و هنوز هم دربارهٔ چگونگی مرگش بحث و اختلاف‌نظر وجود دارد. تشییع جنازه‌اش شهر را پر کرد.' },
        { t: 'h', x: 'And it is still in the room', fa: 'و هنوز هم در همان گود هست' },
        { t: 'p', x: 'This is not history. Ask around any Iranian family and you will hear the same thing said with total confidence: give it to a Persian man and it will get done. Whatever it is. The car, the paperwork, the impossible favour, the thing that officially cannot be arranged.', fa: 'این دیگر فقط تاریخ نیست. در هر خانوادهٔ ایرانی سراغ بگیری، همین جمله را با اطمینان کامل می‌شنوی: بسپارش به یک مرد ایرانی، انجامش می‌دهد. هرچه باشد؛ تعمیر ماشین، کارهای اداری، آن لطفِ ناممکن، یا کاری که رسماً هیچ راهی برای انجام دادنش نیست.' },
        ...
        { t: 'mark', x: 'You do not have to ask a second time. That is the entire compliment, and it is the highest one available.', fa: 'لازم نیست بار دوم هم درخواست کنی. تمام تعریف همین است، و بالاترین تعریفی است که می‌شود از یک مرد کرد.' },
        { t: 'close', x: 'A country that has produced conquerors and kings and poets chose, as the man it loves most, a wrestler who would not touch an injured leg.', fa: 'کشوری که فاتحان و شاهان و شاعران بزرگی به جهان عرضه کرده، محبوب‌ترین مردش را از میان کشتی‌گیران برگزید؛ مردی که حاضر نشد حتی به پای آسیب‌دیدهٔ حریفش دست بزند.' },
      ] },
  ],
  ...
  sofreh: [
    { key: 's1', nav: 'The Spread', navFa: 'سفره', title: 'Everything, All at Once', titleFa: 'همه‌چیز، یکجا', eyebrow: 'سفره',
      blocks: [
        { t: 'lead', x: 'A Persian table is not laid with a meal. It is laid with everything you could possibly need, and then more, in case you need that too.', fa: 'سفرهٔ ایرانی را فقط برای یک وعدهٔ غذا نمی‌چینند. هر چیزی را که ممکن است لازم داشته باشی، سر سفره می‌گذارند؛ و بعد باز هم بیشتر، برای اینکه اگر آن را هم خواستی، آماده باشد.' },
        { t: 'p', x: 'The sofreh is the spread. And the rule of it is abundance: the rice, the stew, the kabab, the bread, the yoghurt, the pickles, the raw herbs, the salad, the butter, the extra plate of rice nobody asked for. It is all there before you sit, and it stays there until you leave.', fa: 'سفره یعنی همهٔ این بساطِ رنگارنگ. و قاعده‌اش فراوانی است: برنج، خورش، کباب، نان، ماست، ترشی، سبزی خوردن، سالاد، کره، و آن بشقاب اضافهٔ برنج که هیچ‌کس درخواستش نکرده. همه‌چیز پیش از آنکه بنشینی سر سفره حاضر است و تا وقتی بروی همان‌جا می‌ماند.' },
        { t: 'p', x: 'Nothing arrives in courses. Nothing is portioned out for you. Everything is in the middle, within reach, and you take what you want and go back for more, and the bowls are refilled while you are still eating out of them.', fa: 'هیچ‌چیز مرحله‌به‌مرحله سر سفره نمی‌آید. هیچ‌چیز هم از قبل برایت سهم‌بندی نمی‌شود. همه‌چیز وسط سفره و دم دست است؛ هرچه بخواهی برمی‌داری، دوباره سراغش می‌روی و ظرف‌ها را همان‌طور که هنوز مشغول خوردنی، دوباره پر می‌کنند.' },
        { t: 'mark', x: 'A guest should never have to ask for anything. That is the whole design of the table.', fa: 'مهمان نباید هیچ‌وقت مجبور شود چیزی بخواهد. تمام فلسفهٔ چیدن سفره همین است.' },
        { t: 'p', x: 'That is why it looks like too much. It is supposed to. A table with exactly enough on it is a table that was calculated, and calculating what a guest needs is the one thing a host must never be caught doing.', fa: 'برای همین است که سفره انگار بیش از حد پُر است. قرار است همین‌طور باشد. سفره‌ای که دقیقاً به اندازهٔ نیاز روی آن چیده شده، یعنی همه‌چیز از قبل حساب شده؛ و حساب‌وکتاب کردنِ اینکه مهمان چه چیزی و چقدر لازم دارد، تنها کاری است که میزبان نباید هرگز هنگام انجامش گیر بیفتد.' },
      ] },
    { key: 's2', nav: 'Rice', navFa: 'برنج', title: 'Rice Is Not a Side Dish', titleFa: 'برنج غذای فرعی نیست', eyebrow: 'THE CENTRE',
      blocks: [
        { t: 'p', x: 'Understand this and you understand the kitchen. In Iran, rice is not something served alongside the meal. Rice is the meal. Everything else is an accompaniment to it, including the meat.', fa: 'این را که بفهمی، آشپزی ایرانی را فهمیده‌ای. در ایران، برنج چیزی نیست که کنار غذا سرو شود؛ برنج خودِ غذاست. هر چیز دیگری همراهِ آن است، حتی گوشت.' },
        ...
        { t: 'rice' },
        { t: 'h', x: 'And the crust', fa: 'و آن پوسته' },
        { t: 'p', x: 'At the bottom of the pot, where the rice meets the oil, a golden crust forms. Tahdig, the bottom of the pot. It is crunchy, it is the best thing on the table, and there is never enough of it.', fa: 'تهِ قابلمه، همان‌جا که برنج به روغن می‌رسد، پوسته‌ای طلایی شکل می‌گیرد: ته‌دیگ، همان تهِ قابلمه. ترد و برشته است، بهترین چیز روی سفره است، و هیچ‌وقت هم به اندازهٔ کافی از آن نیست.' },
        ...
        { t: 'mark', x: 'The greatest thing in Persian cooking is the accident at the bottom of the pot.', fa: 'بهترین چیز در آشپزی ایرانی، همان اتفاقی است که تهِ قابلمه می‌افتد.' },
      ] },
    { key: 's3', nav: 'The Dishes', navFa: 'غذاها', title: 'What Is On It', titleFa: 'چه چیزهایی روی سفره است', eyebrow: 'THE FOOD',
      blocks: [
        { t: 'p', x: 'Touch a dish to see it.', fa: 'روی هر غذا بزن تا ببینیش.' },
        { t: 'dishes' },
      ] },
    { key: 's4', nav: 'The Flavour', navFa: 'طعم', title: 'Sour, Slow, and Never Hot', titleFa: 'ترش، آرام و هرگز تند', eyebrow: 'HOW IT TASTES',
      blocks: [
        ...
        { t: 'p', x: 'It is almost never hot. Iranians do not do chilli. The complexity comes from time and from sour, not from heat, and a stew that has not cooked for four hours is not finished. Ask an Iranian how long ghormeh sabzi takes and the honest answer is most of a day.', fa: 'تقریباً هیچ‌وقت تند نیست. ایرانی‌ها اهل فلفل تند نیستند. پیچیدگیِ طعم از زمان و ترشی می‌آید، نه از تندی؛ و خورشی که چهار ساعت نپخته باشد، هنوز جا نیفتاده است. از یک ایرانی بپرس قرمه‌سبزی چقدر زمان می‌برد، و جواب صادقانه‌اش این است: بیشترِ یک روز.' },
        { t: 'mark', x: 'No heat, no rush, and no shortcuts. Persian food is slow on purpose.', fa: 'نه تندی، نه عجله و نه میان‌بُر. غذای ایرانی عمداً با حوصله پخته می‌شود.' },
        ...
        { t: 'close', x: 'A cuisine of long slow sourness, built around a grain, whose greatest achievement is the crust at the bottom of the pot, laid out all at once so that nobody has to ask for anything.', fa: 'آشپزی‌ای بر پایهٔ ترشیِ آرام و طولانی، حول یک دانه شکل گرفته، که بزرگ‌ترین شاهکارش همان ته‌دیگِ تهِ قابلمه است؛ همه‌چیز هم یکجا روی سفره چیده می‌شود تا هیچ‌کس مجبور نباشد چیزی بخواهد.' },
      ] },
    { key: 's5', nav: 'The Sweet', navFa: 'شیرینی', title: 'After, and In Between', titleFa: 'بعد از غذا، و میان وعده‌ها', eyebrow: 'SHIRINI',
      blocks: [
        { t: 'p', x: 'Persian sweetness is not the sugar of a European dessert. It runs on saffron, rosewater, pistachio, and sour, and quite a lot of it is not really a dessert at all. It is the thing that is out on the table permanently, for anyone who walks in.', fa: 'شیرینیِ ایرانی، آن شیرینیِ پرشکرِ دسرهای اروپایی نیست. عطر و طعمش از زعفران و گلاب و پسته و ترشی می‌آید، و خیلی از چیزهایی که در این دسته قرار می‌گیرند اصلاً دسر به معنای معمول کلمه نیستند. همان چیزهایی‌اند که همیشه روی سفره حاضرند، برای هر کسی که از در وارد شود.' },
        { t: 'sweets' },
        { t: 'mark', x: 'The ice cream stretches, the fruit leather is sour enough to hurt, and there is always a bowl of nuts already out.', fa: 'بستنی کش می‌آید، لواشک آن‌قدر ترش است که دهانت را جمع می‌کند، و همیشه یک کاسه آجیل از قبل روی سفره هست.' },
  ...
  chai: [
    { key: 'c1', nav: 'The Glass', navFa: 'استکان', title: 'Never Just a Drink', titleFa: 'هیچ‌وقت فقط یک نوشیدنی', eyebrow: 'چای',
      blocks: [
        { t: 'lead', x: 'Nobody in Iran has ever had a cup of tea. They have had an occasion, and there was tea in it.', fa: 'هیچ‌کس در ایران تا حالا فقط «یک استکان چای» نخورده است. همیشه اتفاقی در میان بوده و چای هم بخشی از آن بوده است.' },
        { t: 'p', x: 'It arrives when you arrive, before anything is said. It arrives when a deal is being discussed, and again when it is done. It arrives at the end of every meal. Refusing it is not really available to you.', fa: 'همان لحظه که می‌رسی، پیش از آنکه حرفی زده شود، چای می‌آید. وقتی دارند سر معامله‌ای صحبت می‌کنند، می‌آید و وقتی معامله جوش می‌خورد، باز هم می‌آید. آخر هر غذا هم می‌آید. رد کردنش عملاً گزینه‌ای نیست که داشته باشی.' },
    ...
    { key: 'c2', nav: 'The Cube', navFa: 'قند', title: 'The Sugar Goes in Your Mouth', titleFa: 'قند در دهان می‌رود', eyebrow: 'GHAND',
      blocks: [
        { t: 'p', x: 'The thing visitors never forget. The sugar does not go in the glass. You take a hard cube of sugar, ghand, put it between your front teeth, and drink the hot tea through it.', fa: 'چیزی که هیچ مهمانی فراموشش نمی‌کند. قند داخل استکان نمی‌رود. یک حبه قند برمی‌داری، آن را لای دندان‌های جلویت می‌گذاری و چای داغ را از روی آن می‌نوشی.' },
        { t: 'p', x: 'The cube dissolves slowly as the tea passes over it, so the sweetness is at the front and the tea stays clean behind it. One cube can last most of a glass. Watch an old man do it and you will see it is a technique.', fa: 'حبه قند وقتی چای از رویش رد می‌شود، آرام‌آرام آب می‌شود؛ در نتیجه شیرینی در جلوی دهان می‌ماند و چای پشت آن طعم خالص خودش را حفظ می‌کند. یک حبه قند می‌تواند بیشترِ یک استکان دوام بیاورد. کافی است پیرمردی را ببینی که این کار را می‌کند تا بفهمی خودش یک فن است.' },
  ...
  typical: [
    { key: 'tp1', nav: 'The Cards', navFa: 'کارت‌ها', title: 'You Know the Ones', titleFa: 'خودت می‌دانی کدام‌ها را می‌گویم', eyebrow: 'TYPICAL PERSIAN',
      blocks: [
        { t: 'p', x: 'Every Iranian recognises these instantly, and every one of them is a joke with something true sitting underneath it. Tap a card to turn it over.', fa: 'هر ایرانی این‌ها را همان لحظه می‌شناسد؛ چون پشتِ هر کدام، زیرِ شوخی، تکه‌ای از یک حقیقت نشسته است. روی هر کارت بزن تا روی دیگرش را ببینی.' },
        { t: 'cards' },
      ] },
  ],
};
...
export const TYPICAL_CARDS: TypicalCard[] = [
  { front: 'Persian Standard Time is a real unit of measurement.',
    fa: 'وقتِ ایرانی واقعاً یک واحد اندازه‌گیری است.',
  ...
  { front: 'Every Persian knows someone who knows someone.', frontFa: 'هر ایرانی یکی را می‌شناسد که یکی را می‌شناسد.',
  ...
  { front: 'A Persian girl first gift was gold.',
    fa: 'اولین هدیهٔ یک دختر ایرانی، طلاست.',
  ...
  { front: 'Nobody has ever successfully paid a bill at a Persian restaurant.', frontFa: 'هیچ‌کس تا حالا نتوانسته در یک رستوران ایرانی بی‌دردسر حساب کند.',
  ...
  { front: 'The Persian goodbye takes forty minutes.', frontFa: 'خداحافظیِ ایرانی چهل دقیقه طول می‌کشد.',
  ...
  { front: 'Your mother thinks you are too thin.', frontFa: 'مادرت همیشه فکر می‌کند زیادی لاغری.',
    back: 'You have always been too thin. You will be too thin at every weight you ever are. This is not about your body. Feeding you is how she says the thing she was never taught to say out loud, and as long as you are too thin, there is more of it to say.', backFa: 'تو همیشه زیادی لاغر بوده‌ای. هر وزنی هم که داشته باشی، باز هم از نظر او زیادی لاغری. این ماجرا اصلاً دربارهٔ بدن تو نیست. غذا دادن به تو، زبانِ حرفی است که هیچ‌وقت یاد نگرفته با صدای بلند بزند؛ و تا وقتی زیادی لاغری، هنوز حرف‌های بیشتری برای گفتن هست.' },
  { front: 'Everyone is your amoo or khaleh.',
    fa: 'همه برایت عمو یا خاله اند',
  ...
  { front: 'The tahdig will be gone before you get there.',
    fa: 'تا برسی، ته‌دیگ دیگر تمام شده است.',
  ...
  { front: 'Have you eaten is a greeting, not a question.', frontFa: '«غذا خوردی؟» یک سلام است، نه یک سؤال.',
    back: 'It means hello. It also means are you all right, and are you being looked after, and I am checking. In a culture where you do not ask someone directly how they are doing, you ask about the one thing that would show it.', backFa: 'یعنی سلام. در عین حال یعنی حالت خوب است؟ یعنی کسی هوایت را دارد؟ یعنی دارم حواسم به تو هست. در فرهنگی که مستقیم از کسی نمی‌پرسند حالت چطور است، سراغ همان یک چیزی می‌روند که جوابش همه‌چیز را لو می‌دهد.' },
  { front: 'There is a room in the house nobody is allowed to sit in.', frontFa: 'یک اتاق در خانه هست که هیچ‌کس اجازه ندارد در آن بنشیند.',
  ...
  { front: 'You will leave with food you did not ask for.', frontFa: 'با غذایی از خانه بیرون می‌آیی که اصلاً نخواسته بودی.',
    back: 'In a container that must be returned, which means you must come back. It is a very old trick and it is not remotely accidental. Nobody has ever returned a Persian container empty, either, so the whole thing loops forever, which is the design.', backFa: 'در ظرفی که باید پسش بدهی، یعنی باید دوباره برگردی. این ترفندی بسیار قدیمی است و ذره‌ای هم تصادفی نیست. تازه، هیچ‌کس هم تا حالا ظرف یک ایرانی را خالی پس نداده؛ پس این چرخه تا ابد ادامه پیدا می‌کند، و دقیقاً قرار است همین‌طور باشد.' },
  { front: 'Shoes come off. This is not negotiable.', frontFa: 'کفش‌ها درمی‌آیند. این یکی جای بحث ندارد.',
    back: 'Not a preference, not a house rule, not a request. It happens at the door without anyone saying anything. Persians sit on floors, eat on floors, sleep on floors. The floor is not the ground, it is furniture, and you do not stand on furniture in your shoes.', backFa: 'نه سلیقه است، نه قانون خانه، نه درخواست. همان دمِ در اتفاق می‌افتد، بی‌آنکه کسی چیزی بگوید. ایرانی‌ها روی زمین می‌نشینند، روی زمین غذا می‌خورند و روی زمین می‌خوابند. کف خانه «زمین» نیست، مبلمان است؛ و آدم با کفش روی مبل نمی‌ایستد.' },
  { front: 'Saffron is measured in fear.',
    fa: 'زعفران با ترس پیمانه می‌شود.',
  ...
  { front: 'Your cousin is a doctor. You will hear about it.', frontFa: 'پسرخاله‌ات دکتر شده. حتماً خبرش را به تو می‌دهند.',
...
export const DISHES: Dish[] = [
  ...
  { key: 'fesenjan', fa: 'فسنجان', name: 'Fesenjan', tag: 'THE STRANGE ONE', tagFa: 'آن یکی عجیب', image: 'food-fesenjan',
    x: 'Chicken or duck in ground walnuts and pomegranate molasses, cooked until the walnut oil separates and the sauce goes almost black. Dark, sour, sweet, and completely unlike anything in any other cuisine. It is the dish that surprises people most.', xFa: 'مرغ یا اردک با گردوی ساییده و رب انار، که آن‌قدر می‌پزد تا روغن گردو پس بدهد و رنگ خورش تقریباً سیاه شود. تیره، ترش و شیرین است و در هیچ آشپزی دیگری نظیری برایش پیدا نمی‌شود. غذایی است که بیش از هر چیز دیگری آدم‌ها را غافلگیر می‌کند.' },
  { key: 'zereshk', fa: 'زرشک پلو', name: 'Zereshk Polo', tag: 'THE JEWELLED ONE', tagFa: 'جواهرنشان', image: 'food-zereshk-polo',
    x: 'Saffron rice scattered with barberries, tiny sour red jewels, served with chicken. It is what appears at weddings and at every occasion that matters, because it is beautiful before anyone has tasted it. The barberries are sharp enough to make you blink.', xFa: 'برنج زعفرانی که با زرشک، این جواهرهای ریزِ سرخ و ترش، آراسته شده و با مرغ سرو می‌شود. همان چیزی است که سرِ سفرهٔ عروسی و هر مناسبت مهمی می‌آید، چون پیش از آنکه کسی مزه‌اش را بچشد، زیباست. زرشک آن‌قدر ترش و تیز است که چشم‌هایت را جمع می‌کنی.' },
  { key: 'lobia', fa: 'لوبیا پلو', name: 'Lobia Polo', tag: 'THE WEEKNIGHT ONE', tagFa: 'غذای شب‌های معمولی', image: 'food-lobia-polo',
    x: 'Green beans and minced meat cooked with tomato and cinnamon and folded through the rice, so the rice is the dish rather than a bed for it. Homely, quick by Persian standards, and the one that Iranians abroad make when they are homesick and short of time.', xFa: 'لوبیا سبز و گوشت چرخ‌کرده که با گوجه و دارچین پخته می‌شود و لابه‌لای برنج می‌رود، طوری که برنج خودش غذاست، نه بستری برای آن. غذایی خانگی است، به معیار ایرانی نسبتاً سریع، و همان غذایی است که ایرانی‌های خارج از کشور وقتی دلتنگ خانه‌اند و وقت کمی دارند، درست می‌کنند.' },
  { key: 'koobideh', fa: 'کوبیده', name: 'Kabab Koobideh', tag: 'THE EVERYDAY ONE', tagFa: 'غذای هرروزه', image: 'food-koobideh',
    x: 'Minced lamb and onion pressed by hand onto a flat wide skewer and grilled over coal. Eaten with rice, a grilled tomato, raw onion, and sumac. It looks simple and it is not. If the mix is wrong it falls off the skewer into the fire, and the whole skill is in the hands.', xFa: 'گوشت چرخ‌کردهٔ گوسفند و پیاز که با دست روی سیخ پهن فشرده می‌شود و روی زغال کباب می‌شود. با برنج، گوجهٔ کبابی، پیاز خام و سماق خورده می‌شود. ساده به نظر می‌رسد، اما ساده نیست. اگر مایه‌اش درست نباشد، از سیخ می‌افتد توی آتش؛ و تمام هنرِ کار در دست‌هاست.' },
  { key: 'ash', fa: 'آش رشته', name: 'Ash Reshte', tag: 'THE ONE YOU GIVE AWAY', tagFa: 'آن یکی که نذری می‌دهند', image: 'food-ash-reshte',
    x: 'Thick soup of herbs, beans, and noodles, finished with kashk, a tart dried whey. Made in enormous pots, and traditionally made to be given away: cooked as a vow and handed out to neighbours and strangers. Making ash for the whole street is an act of charity with its own name.', xFa: 'آشی غلیظ از سبزی، حبوبات و رشته که با کشک، این فرآوردهٔ ترشِ حاصل از آب‌پنیر خشک‌شده، تمام می‌شود. آن را در دیگ‌های بزرگ می‌پزند و به‌طور سنتی برای بخشیدن به دیگران درست می‌کنند: نذری می‌پزند و میان همسایه‌ها و غریبه‌ها پخش می‌کنند. آش پختن برای کل کوچه، نوعی کار خیر است که خودش اسم و رسم دارد.' },
  ...
  { key: 'tahdig', fa: 'ته دیگ', name: 'Tahdig', tag: 'THE PRIZE', tagFa: 'جایزه', image: 'food-tahdig',
    x: 'The golden crust from the bottom of the rice pot. Sometimes plain rice, sometimes with potato or flatbread laid underneath. It is turned out at the table and it is gone within a minute, and there has never in the history of Iran been enough of it.', xFa: 'همان پوستهٔ طلاییِ تهِ قابلمهٔ برنج. گاهی خودِ برنج است، گاهی سیب‌زمینی یا نان لواش زیرش گذاشته‌اند. سر سفره برش می‌گردانند و ظرف یک دقیقه تمام می‌شود؛ و در تمام تاریخ ایران حتی یک بار هم به اندازهٔ کافی از آن نبوده است.' },
  { key: 'sabzi', fa: 'سبزی خوردن', name: 'Sabzi Khordan', tag: 'ON EVERY TABLE', tagFa: 'سر هر سفره‌ای', image: 'food-sabzi-khordan',
    x: 'A plate of raw herbs. Mint, tarragon, basil, radish, spring onion. Eaten by the handful with bread, white cheese, and walnuts, throughout the meal, not before it. Iranians eat more raw herbs than almost anyone, and it is the flavour they miss most abroad.', xFa: 'یک بشقاب سبزی تازه. نعنا، ترخون، ریحان، تربچه، پیازچه. مشت‌مشت با نان و پنیر و گردو، در طول غذا خورده می‌شود، نه پیش از آن. ایرانی‌ها بیش از تقریباً هر ملت دیگری سبزی خام می‌خورند و همین طعمی است که در خارج از کشور بیش از هر چیز دیگری دلشان برایش تنگ می‌شود.' },
  { key: 'baghali', fa: 'باقالی پلو', name: 'Baghali Polo', tag: 'THE SPRING ONE', tagFa: 'غذای بهاری', image: 'food-baghali-polo',
    x: 'Rice steamed with broad beans and enough dill to turn the whole pot green, served with a lamb shank that gives way to a fork. The dill is not a hint of dill. It is most of the dish, and it is what a Persian kitchen smells like in spring.', xFa: 'برنجی که با باقالی و آن‌قدر شوید دم می‌کشد که تمام قابلمه سبز می‌شود و با ماهیچه‌ای سرو می‌شود که با فشار چنگال از هم باز می‌شود. شوید در این غذا فقط یک عطر و طعمِ فرعی نیست؛ بخش اصلی غذاست و همان بویی است که آشپزخانهٔ ایرانی در بهار می‌دهد.' },
  { key: 'adas', fa: 'عدس پلو', name: 'Adas Polo', tag: 'SWEET IN THE MIDDLE OF THE MEAL', tagFa: 'شیرینی، وسط غذا', image: 'food-adas-polo',
    x: 'Lentils and rice with raisins, dates and fried onion, often cinnamon, sometimes minced meat. It unsettles anyone who believes sweetness belongs at the end of a meal. In Iran it belongs in the middle of the rice.', xFa: 'عدس و برنج با کشمش، خرما و پیاز داغ، اغلب با دارچین و گاهی با گوشت چرخ‌کرده. هر کسی را که فکر می‌کند شیرینی جای آخرِ غذاست، غافلگیر می‌کند. در ایران، جای شیرینی وسطِ برنج است.' },
  { key: 'sabzipolo', fa: 'سبزی پلو ماهی', name: 'Sabzi Polo Mahi', tag: 'THE FIRST MEAL OF THE YEAR', tagFa: 'نخستین غذای سال', image: 'food-sabzi-polo-mahi',
    x: 'Herbed rice with fried white fish, eaten on the night of Nowruz in almost every Iranian house there is. Green for the new year, fish for the life in the water. It is the one meal in the calendar that nearly everybody eats on the same evening.', xFa: 'برنج سبزی‌دار با ماهی سفیدِ سرخ‌شده، که شب نوروز تقریباً در هر خانهٔ ایرانی بر سر سفره می‌آید. سبزی‌اش برای سال نوست و ماهی‌اش برای زندگی در آب. تنها وعده‌ای در تقویم است که تقریباً همه، در یک شب، می‌خورند.' },
  { key: 'mirza', fa: 'میرزا قاسمی', name: 'Mirza Ghasemi', tag: 'SMOKE, FROM THE CASPIAN', tagFa: 'دود، از شمال', image: 'food-mirza-ghasemi',
    x: 'Aubergine held over a flame until the skin blisters and splits, then mashed with garlic, tomato and egg. From Gilan on the Caspian coast, and the smoke is the entire point. Cooked in an oven instead of over fire it becomes a different and lesser dish.', xFa: 'بادمجان را روی شعله نگه می‌دارند تا پوستش تاول بزند و ترک بخورد، بعد با سیر و گوجه و تخم‌مرغ له می‌کنند. این غذا از گیلان، در کرانهٔ دریای کاسپین، می‌آید و تمام ماجرا همان دود و عطرِ دودی است. اگر به‌جای آتش در فر پخته شود، هم غذای دیگری می‌شود و هم چیزی از آن کم می‌شود.' },
  { key: 'kashk', fa: 'کشک بادمجان', name: 'Kashk-e Bademjan', tag: 'THE ONE THAT ARRIVES FIRST', tagFa: 'آن یکی که اول می‌آید', image: 'food-kashk-bademjan',
    x: 'Fried aubergine crushed with garlic and mint oil, finished with kashk, a fermented whey whose sourness sits closer to cheese than to yoghurt. It comes out before the meal, it is eaten with bread, and it is usually gone before the rice arrives.', xFa: 'بادمجان سرخ‌شده که با سیر و نعنا داغ کوبیده می‌شود و در آخر با کشک تمامش می‌کنند؛ کشکی که از آب‌پنیر تخمیرشده به دست می‌آید و ترشی‌اش بیشتر به پنیر نزدیک است تا ماست. پیش از غذا سر سفره می‌آید، با نان خورده می‌شود و معمولاً پیش از رسیدن برنج تمام شده است.' },
  { key: 'karafs', fa: 'خورش کرفس', name: 'Khoresh-e Karafs', tag: 'THE UNDERRATED ONE', tagFa: 'آن یکی که دست‌کم گرفته می‌شود', image: 'food-khoresh-karafs',
    x: 'Celery stewed slowly with lamb, mint and parsley, then sharpened at the end with lemon or sour grape juice. Most cuisines use celery for flavour and throw it away. Persian cooking puts it at the centre of the dish, and is right to.', xFa: 'کرفس که آرام‌آرام با گوشت بره، نعنا و جعفری می‌پزد و آخر کار با لیمو یا آبغوره طعمش تیزتر می‌شود. در بیشتر آشپزی‌ها کرفس را فقط برای طعم دادن به کار می‌برند و بعد دور می‌ریزند. آشپزی ایرانی آن را در مرکز غذا می‌گذارد، و کار درستی هم می‌کند.' },
...
export const SWEETS: Dish[] = [
  ...
  { key: 'faloodeh', fa: 'فالوده', name: 'Faloodeh', tag: 'OLDER THAN YOU THINK', tagFa: 'کهن‌تر از آن چیزی که فکر می‌کنی', image: 'food-faloodeh',
  ...
  { key: 'lavashak', fa: 'لواشک', name: 'Lavashak', tag: 'EVERY PERSIAN CHILDHOOD', tagFa: 'کودکیِ هر ایرانی', image: 'food-lavashak',

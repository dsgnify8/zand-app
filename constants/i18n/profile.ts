...
export const PROFILE: Record<string, T> = {
  // tabs
  you: { en: 'You', fa: 'تو' },
  library: { en: 'Library', fa: 'کتابخونه' },
  ...
  // you
  pickUp: { en: 'PICK UP WHERE YOU LEFT OFF', fa: 'از همون‌جا ادامه بده' },
  notSeen: { en: 'SOMETHING YOU HAVE NOT SEEN', fa: 'چیزی که هنوز ندیدی' },
  daysRow: { en: 'DAYS IN A ROW', fa: 'روز پشت سر هم' },

  // library
  yourLibrary: { en: 'YOUR LIBRARY', fa: 'کتابخونهٔ تو' },
  mySaved: { en: 'MY SAVED', fa: 'ذخیره‌شده‌ها' },
  thingsKept: { en: 'THINGS YOU KEPT', fa: 'چیزهایی که نگه داشتی' },
  history: { en: 'History', fa: 'تاریخچه' },
  historyX: { en: 'everything you have opened', fa: 'هر چیزی که باز کردی' },
  favourites: { en: 'Favourites', fa: 'محبوب‌ها' },
  favouritesX: { en: 'the ones you loved', fa: 'اون‌هایی که دوست داشتی' },
  watched: { en: 'Watched', fa: 'دیده‌شده‌ها' },
  watchedX: { en: 'videos you watched', fa: 'ویدیوهایی که دیدی' },
  saveLater: { en: 'Save for later', fa: 'بمونه برای بعد' },
  saveLaterX: { en: 'to come back to', fa: 'که بعداً برگردی سراغش' },

  // friends
  teachEachOther: { en: 'Teach each other', fa: 'به هم یاد بدید' },
  teachX: {
  ...
  finished: { en: 'FINISHED', fa: 'تمام‌شده‌ها' },
  finishedEmpty: {
    en: 'Finish a topic or an article and it lands here.',
    fa: 'یک موضوع یا مقاله را تمام کن تا اینجا بیاید.',
  },
  ...
  thingsSaved: { en: 'Things saved', fa: 'ذخیره‌شده‌ها' },
  sentToFriends: { en: 'Sent to friends', fa: 'فرستاده‌شده' },
};

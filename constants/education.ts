  ...
  chapters: [
    ...
    },
    {
      ...
      pages: [
        ...
        { blocks: [
          { t: 'h', x: 'Mohammad Reza Pahlavi becomes king', fa: 'محمدرضا پهلوی شاه می‌شود', fa: 'محمدرضا پهلوی شاه می‌شود' },
    ...
    },
    {
      ...
      pages: [
        ...
        { blocks: [
          ...
          { t: 'p', x: "To the world he still stood at the peak of his power. Beneath it, the ground was beginning to shift.", fa: 'در چشم جهان هنوز در اوج قدرتش ایستاده بود. زیر پایش اما، زمین داشت می‌لرزید.', fa: 'در چشم جهان هنوز در اوج قدرتش ایستاده بود. زیر پایش اما، زمین داشت می‌لرزید.' },
        ] },
      ],
    },
    {
  ...
  chapters: [
    {
      ...
      pages: [
        ...
        { blocks: [
          ...
          { t: 'q', x: 'This boy, the son of a herdsman as we supposed, is in truth the grandson of the king.', fa: 'این پسر که او را پسر چوپان می‌پنداشتیم، در حقیقت نوهٔ شاه است.', by: 'Herodotus, The Histories', byFa: 'هرودوت، تاریخ' },
        ] },
        { blocks: [
    ...
    },
    {
      ...
      pages: [
        ...
        { blocks: [
          ...
          { t: 'splitimg', key: 'ilkhanate-rashid', title: 'Rashid al-Din', titleFa: 'رشیدالدین فضل‌الله', x: 'The Persian vizier and scholar who wrote a history of the world, and helped transform the Mongol conquerors into patrons of Persian civilization.', fa: 'وزیر و دانشمند ایرانی که جامع‌التواریخ را نوشت و در بدل کردن فاتحان مغول به حامیان تمدن ایرانی سهم داشت.', fa: 'وزیر و دانشمند ایرانی که جامع‌التواریخ را نوشت و در بدل کردن فاتحان مغول به حامیان تمدن ایرانی سهم داشت.' },
        ] },
        { blocks: [
          { t: 'div' },

  ...
  chapters: [
    {
      ...
      pages: [
        { blocks: [
          ...
          { t: 'p', x: 'Reza Khan was born on 15 March 1878 in Alasht, a small village high in the mountains of Mazandaran, in the green north of Iran. His people were of modest means, and the world he entered was a hard one, far from the comforts of the capital.', fa: 'رضاخان در ۱۵ مارس ۱۸۷۸ در الاشت به دنیا آمد؛ روستایی کوچک در ارتفاعات مازندران، در شمال سرسبز ایران. خانواده‌اش تنگدست بودند و دنیایی که پا به آن گذاشت، دنیایی سخت و دور از آسایش پایتخت بود.' },
          { t: 'p', x: 'His father, an officer, died when Reza was only a few months old. His mother carried her infant son through winter snows toward Tehran to find family, a journey that nearly cost them both their lives. He grew up without wealth or connection, shaped early by hardship and by his own stubborn strength of will.', fa: 'پدرش که افسر بود، وقتی رضا تنها چند ماه داشت درگذشت. مادرش نوزادش را در میان برف‌های زمستان به سوی تهران برد تا نزد خویشاوندان برود؛ سفری که نزدیک بود جان هر دویشان را بگیرد. بدون ثروت و پشتوانه بزرگ شد و از همان کودکی، سختی‌ها و اراده سرسخت خودش شخصیتش را شکل دادند.' },
          { t: 'imgsm', key: 'reza-teen', cap: 'Reza Khan in his youth, before his rise through the ranks.', capFa: 'رضاخان در جوانی، پیش از آنکه در سلسله‌مراتب نظامی بالا برود.' },
        ] },
        { blocks: [
          ...
          { t: 'p', x: 'The Iran around him was a nation in decline, its government bankrupt, its provinces ruled by tribes and foreign interests, its affairs decided in London and Saint Petersburg. For a proud soldier who loved his country, the humiliation was a fire that would drive him for the rest of his life.', fa: 'ایرانی که پیرامونش می‌دید، کشوری رو به افول بود؛ دولتش ورشکسته، ولایاتش در دست ایل‌ها و منافع بیگانه، و سرنوشت امورش در لندن و سن‌پترزبورگ تعیین می‌شد. برای سربازی سربلند که کشورش را دوست داشت، این خواری آتشی بود که تا پایان عمر او را به پیش می‌راند.' },
        ] },
      ],
    },
    {
      ...
      pages: [
        ...
        { blocks: [
          ...
          { t: 'imgsm', key: 'reza-coup', cap: 'Reza Khan at the time of the march on Tehran, 1921.', capFa: 'رضاخان در زمان حرکت به سوی تهران، ۱۲۹۹.' },
        ] },
        { blocks: [
          { t: 'p', x: 'Over the next four years he gathered the reins of the state into his own hands. He crushed the tribal rebellions and separatist revolts that had torn the provinces apart, and for the first time in living memory, a single authority reached from Tehran to the farthest corners of the country.', fa: 'در چهار سال بعد، افسار حکومت را یکسره در دست گرفت. شورش‌های ایلی و جنبش‌های جدایی‌خواهی را که ولایات را از هم گسسته بودند سرکوب کرد و برای نخستین بار در حافظه نسل زنده، قدرتی واحد از تهران تا دورترین گوشه‌های کشور اعمال می‌شد.' },
          { t: 'p', x: 'In 1923 he became prime minister. The old dynasty was fading, and the nation was ready for a strong hand. In 1925, with the approval of a constituent assembly, the Qajar dynasty was set aside, and Reza Khan was proclaimed Reza Shah Pahlavi, founder of a new royal house.', fa: 'در سال ۱۹۲۳ نخست‌وزیر شد. سلسله کهنه رو به افول بود و کشور آماده پذیرش دستی نیرومند بود. در سال ۱۹۲۵، با تصویب مجلس مؤسسان، سلسله قاجار کنار گذاشته شد و رضاخان با عنوان رضاشاه پهلوی، بنیان‌گذار خاندان سلطنتی تازه، بر تخت نشست.' },
          { t: 'timeline', items: [
    ...
    },
    {
      ...
      pages: [
        { blocks: [
          ...
          { t: 'steps', items: [
            { title: 'A national army', titleFa: 'ارتشی ملی', x: 'A modern conscript army that ended the tribal revolts and unified the land under one authority.', fa: 'ارتشی مدرن و مبتنی بر خدمت وظیفه که به شورش‌های ایلی پایان داد و کشور را زیر یک قدرت واحد متحد کرد.' },
            { title: 'The Trans-Iranian Railway', titleFa: 'راه‌آهن سراسری', x: 'A railway binding the Persian Gulf to the Caspian, built with Iranian money alone.', fa: 'راه‌آهنی که خلیج فارس را به دریای خزر پیوند داد و تنها با پول ایران ساخته شد.' },
            { title: 'Schools and a university', titleFa: 'مدرسه و دانشگاه', x: 'Compulsory primary education, the University of Tehran in 1934, and thousands of students sent to study in Europe.', fa: 'آموزش ابتدایی اجباری، تأسیس دانشگاه تهران در سال ۱۳۱۳، و اعزام هزاران دانشجو برای تحصیل به اروپا.' },
            { title: 'A modern state', titleFa: 'دولتی مدرن', x: 'Roads, factories, a civil code, land registered and forests nationalized, a government that finally reached the whole country.', fa: 'جاده‌ها، کارخانه‌ها، قانون مدنی، ثبت زمین‌ها و ملی شدن جنگل‌ها؛ دولتی که سرانجام در سراسر کشور حضور داشت.' },
          ] },
          { t: 'p', x: 'He created a modern conscript army and ended the tribal revolts that had long divided the land. He founded the University of Tehran in 1934, made primary schooling compulsory, and sent thousands of young Iranians to study in Europe so they might return and build the nation.', fa: 'ارتشی مدرن و مبتنی بر خدمت وظیفه ساخت و به شورش‌های ایلی که سال‌ها کشور را چندپاره کرده بودند پایان داد. در سال ۱۳۱۳ دانشگاه تهران را بنیان گذاشت، آموزش ابتدایی را اجباری کرد و هزاران جوان ایرانی را برای تحصیل به اروپا فرستاد تا بازگردند و کشور را بسازند.' },
        ] },
        { blocks: [
          ...
          { t: 'imgsm', key: 'reza-serving', cap: 'Reza Shah, the builder of the modern Iranian state.', capFa: 'رضاشاه، سازنده دولت مدرن ایران.' },
        ] },
        { blocks: [
          { t: 'h', x: 'The railway across the roof of Iran', fa: 'راه‌آهنی از بام ایران' },
          { t: 'p', x: 'Of all he built, the Trans-Iranian Railway was his proudest achievement. Stretching one thousand three hundred and ninety four kilometres, it bound the Persian Gulf in the south to the Caspian Sea in the north, crossing the length of a rugged and mountainous land.', fa: 'از میان همه آنچه ساخت، راه‌آهن سراسری بیش از همه مایه افتخارش بود. این راه‌آهن با طول هزار و سیصد و نود و چهار کیلومتر، خلیج فارس در جنوب را به دریای خزر در شمال پیوند می‌داد و سراسر سرزمینی ناهموار و کوهستانی را درمی‌نوردید.' },
          { t: 'stat', items: [
        ...
        { blocks: [
          { t: 'p', x: 'The route climbed over the Zagros and the Alborz, the two great mountain ranges, rising past two thousand two hundred metres at its highest point, near the very limit of what the steam engines of the day could manage. It required more than ninety kilometres of tunnels and over four thousand bridges.', fa: 'مسیر از زاگرس و البرز، دو رشته‌کوه بزرگ ایران، عبور می‌کرد و در بلندترین نقطه خود به ارتفاعی بیش از دو هزار و دویست متر می‌رسید؛ تقریباً تا مرز توان لکوموتیوهای بخار آن روزگار. ساخت آن به بیش از نود کیلومتر تونل و بیش از چهار هزار پل نیاز داشت.' },
          ...
          { t: 'q', x: 'Now I can die in peace. I have connected the Persian Gulf to the Caspian with Iranian hands and Iranian money.', fa: 'حالا می‌توانم با خیال آسوده بمیرم. خلیج فارس را با دست ایرانی و پول ایرانی به دریای خزر پیوند دادم.', by: 'Reza Shah, at the railway\'s opening, 1938', byFa: 'رضاشاه، در افتتاح راه‌آهن، ۱۳۱۷' },
          { t: 'img', key: 'iran-railway', cap: 'The Trans-Iranian Railway, binding the Persian Gulf to the Caspian across 1,394 km.', capFa: 'راه‌آهن سراسری ایران، که در طول ۱۳۹۴ کیلومتر خلیج فارس را به دریای خزر پیوند داد.' },
          { t: 'p', x: 'The railway was inaugurated with great ceremony on 26 August 1938. Years later, during the Second World War, this same line became the vital Persian Corridor, carrying nearly five million tons of supplies to the Soviet Union. It remains in daily use to this day.', fa: 'راه‌آهن در ۴ شهریور ۱۳۱۷ با تشریفاتی باشکوه افتتاح شد. سال‌ها بعد، در جریان جنگ جهانی دوم، همین خط به کریدور حیاتی ایران تبدیل شد و نزدیک به پنج میلیون تن تدارکات را به اتحاد شوروی رساند. این خط هنوز هم هر روز مورد استفاده قرار می‌گیرد.' },
        ] },
      ],
    },
    {
      ...
      pages: [
        { blocks: [
          { t: 'p', x: 'Behind the towering public figure was a father whose children remembered him with deep love and no small awe. He was stern, demanding, and impatient with weakness, yet those closest to him spoke of a warmth and a tenderness that the public rarely saw.', fa: 'پشت آن چهره قدرتمند و پرابهت، پدری بود که فرزندانش با عشقی عمیق و هیبتی کم‌نظیر از او یاد می‌کردند. سختگیر و پرتوقع بود و با ضعف و سستی کنار نمی‌آمد؛ اما نزدیک‌ترین کسانش از گرمی و مهری می‌گفتند که مردم کمتر از او می‌دیدند.' },
          { t: 'img', key: 'reza-children', cap: 'Reza Shah with his children, among them the future Shah, Mohammad Reza.', capFa: 'رضاشاه در کنار فرزندانش، از جمله محمدرضا، شاه آینده.' },
          { t: 'img', key: 'reza-command', cap: 'Reza Shah with his son and heir, the young Mohammad Reza.', capFa: 'رضاشاه در کنار پسر و ولیعهدش، محمدرضای جوان.' },
          { t: 'p', x: 'He raised his sons and daughters to serve Iran, and he placed on his eldest son and heir, Mohammad Reza, the heaviest expectations of all. In the family memoirs his children describe a man of simple habits and iron discipline, who rose early, worked without rest, and expected the same of everyone around him.', fa: 'پسران و دخترانش را برای خدمت به ایران تربیت کرد و سنگین‌ترین انتظارها را از پسر بزرگ و ولیعهدش، محمدرضا، داشت. فرزندانش در خاطرات خانوادگی از مردی با عادت‌هایی ساده و انضباطی آهنین یاد می‌کنند؛ مردی که صبح زود از خواب برمی‌خاست، بی‌وقفه کار می‌کرد و همین را از همه اطرافیانش انتظار داشت.' },
        ] },
        { blocks: [
          { t: 'p', x: 'He had little patience for luxury or ceremony for its own sake. What moved him was the work of building, and he threw himself into it with a soldier\'s single mindedness. He would appear without warning at a worksite or a barracks or a school, inspecting, questioning, driving the work forward.', fa: 'حوصله چندانی برای تجمل یا تشریفاتِ صرفاً تشریفاتی نداشت. چیزی که برایش اهمیت داشت، کارِ ساختن بود و با تمرکز و جدیتی شبیه یک سرباز، خود را وقف آن می‌کرد. بی‌خبر سرِ یک کارگاه، پادگان یا مدرسه حاضر می‌شد، بازرسی می‌کرد، سؤال می‌پرسید و کار را به جلو می‌راند.' },
          { t: 'img', key: 'reza-young-kids', cap: 'The young royal children, raised to serve the nation their father was building.', capFa: 'فرزندان خردسال خاندان سلطنتی، که برای خدمت به کشوری تربیت می‌شدند که پدرشان در حال ساختنش بود.' },
          { t: 'p', x: 'To his children he was the fixed point around which the whole household turned. They remembered his rare smiles as precious things, and carried his example, his devotion to Iran above all else, for the rest of their lives.', fa: 'برای فرزندانش نقطه ثابتی بود که تمام خانه حول آن می‌چرخید. لبخندهای کمیابش را چون خاطراتی گران‌بها به یاد داشتند و سرمشق او، یعنی دلبستگی‌اش به ایران بیش از هر چیز دیگری، را تا پایان عمر با خود داشتند.' },
        ] },
      ],
    },
    {
      ...
      pages: [
        ...
        { blocks: [
          ...
          { t: 'p', x: 'They demanded that Iran expel its German nationals and grant free passage for Allied supplies. Reza Shah, proud and unwilling to surrender his country\'s neutrality, sought to negotiate rather than simply submit.', fa: 'آنها از ایران خواستند اتباع آلمانی را اخراج کند و اجازه دهد تدارکات متفقین آزادانه از خاک کشور عبور کند. رضاشاه، که سربلند بود و حاضر نبود بی‌طرفی کشورش را واگذار کند، تلاش کرد مذاکره کند، نه اینکه صرفاً تسلیم شود.' },
        ] },
        { blocks: [
          { t: 'h', x: 'The invasion', fa: 'حمله' },
          { t: 'p', x: 'On 25 August 1941, British forces invaded from the south and Soviet forces from the north. The army that Reza Shah had spent his reign building, the pride of his modern state, was overwhelmed within days by the two great powers striking together.', fa: 'در ۳ شهریور ۱۳۲۰، نیروهای بریتانیا از جنوب و نیروهای شوروی از شمال به ایران حمله کردند. ارتشی که رضاشاه تمام دوران سلطنتش را صرف ساختن آن کرده بود و مایه افتخار دولت مدرنش بود، ظرف چند روز زیر حمله هم‌زمان دو قدرت بزرگ از پا درآمد.' },
          { t: 'p', x: 'It was a bitter blow. The very foundation of his life\'s work, a strong and independent Iran, was overrun by the same foreign powers he had spent twenty years trying to keep at bay.', fa: 'ضربه‌ای تلخ بود. همان چیزی که پایه تمام کارهای زندگی‌اش بود، یعنی ایرانی نیرومند و مستقل، به دست همان قدرت‌های بیگانه‌ای اشغال شد که بیست سال تلاش کرده بود آنها را از کشور دور نگه دارد.' },
        ] },
      ],
    },
    {
      ...
      pages: [
        ...
        { blocks: [
          ...
          { t: 'pull', x: 'He built modern Iran almost single handedly, in only sixteen years.', fa: 'او تقریباً به‌تنهایی ایران مدرن را ساخت، آن هم تنها در شانزده سال.' },
        ] },
        { blocks: [
          { t: 'div' },
          ...
          { t: 'p', x: 'He was a hard man in a hard time, and he asked much of his country and his family. Yet his devotion to Iran never wavered, and the modern nation his son would inherit, and that Iranians would carry forward, was in great part his to build. He gave his life to the making of modern Iran.', fa: 'مردی سخت بود در روزگاری سخت و از کشور و خانواده‌اش بسیار می‌خواست. با این همه، دلبستگی‌اش به ایران هرگز تزلزل پیدا نکرد و ایران مدرنی که پسرش به ارث برد و ایرانیان آن را به پیش بردند، تا حد زیادی حاصل کار او بود. او زندگی‌اش را وقف ساختن ایران مدرن کرد.' },
          { t: 'pull', x: 'From a mountain village, he built a nation.', fa: 'از یک روستای کوهستانی برخاست و ملتی ساخت.' },
        ] },
      ],
    },
  ],
  ...
  chapters: [
    {
      ...
      pages: [
        { blocks: [
          { t: 'p', x: 'More than two and a half thousand years ago, in the highlands of what is now southern Iran, a child was born who would change the shape of the ancient world. His name was Kurush, whom history remembers as Cyrus, and the empire he built would be the largest the world had yet seen.', fa: 'بیش از دو هزار و پانصد سال پیش، در سرزمین‌های کوهستانی جایی که امروز جنوب ایران است، کودکی به دنیا آمد که قرار بود چهره جهان باستان را دگرگون کند. نامش کوروش بود و امپراتوری‌ای که بنا کرد، بزرگ‌ترین امپراتوری‌ای شد که جهان تا آن زمان به خود دیده بود.' },
          { t: 'p', x: 'The land of his birth, Persia, was then a small kingdom of herders and farmers, a subject people living in the shadow of the mighty Median Empire to their north. Few could have imagined that from this modest place would rise a ruler whose name would still be spoken with reverence across the world, so many centuries later.', fa: 'سرزمین زادگاهش، پارس، در آن روزگار پادشاهی کوچکی از چوپانان و کشاورزان بود؛ مردمانی زیر فرمان و در سایه امپراتوری نیرومند ماد در شمال. کمتر کسی تصور می‌کرد از چنین جای کوچکی فرمانروایی برخیزد که قرن‌ها بعد، هنوز نامش با احترام در سراسر جهان برده شود.' },
        ...
        { blocks: [
          { t: 'h', x: 'The legend of the infant king', fa: 'افسانه شاهِ نوزاد' },
          ...
          { t: 'q', x: 'This boy, the son of a herdsman as we supposed, is in truth the grandson of the king.', fa: 'این پسر، که گمان می‌کردیم فرزند چوپانی است، در حقیقت نوه شاه است.', by: 'Herodotus, The Histories', byFa: 'هرودوت، تاریخ' },
        ] },
        { blocks: [
        ...
        { blocks: [
          ...
          { t: 'imgwide', key: 'cyrus-empire', cap: 'The Achaemenid Empire at its height, from the Aegean and Egypt to the Indus. Its capital, Pasargadae, is marked in gold.', capFa: 'شاهنشاهی هخامنشی در اوج خود، از دریای اژه و مصر تا رود سند. پایتختش، پاسارگاد، با رنگ طلایی نشان داده شده.' },
          ...
          { t: 'pull', x: 'From a small kingdom of herders, he would build the greatest empire the world had known.', fa: 'او از پادشاهی کوچک چوپانان، بزرگ‌ترین امپراتوری جهان آن روز را ساخت.' },
        ] },
      ],
    },
    {
    ...
    },
    {
      ...
      pages: [
        ...
        { blocks: [
          ...
          { t: 'imgwide', key: 'cyrus-conquests', cap: 'The conquests of Cyrus, in sequence: Media, then Lydia, then Babylon.', capFa: 'فتوحات کوروش، به ترتیب: ماد، سپس لیدی، سپس بابل.' },
        ] },
        { blocks: [
    ...
    },
    {
      ...
      pages: [
        { blocks: [
          { t: 'p', x: 'Now only one of the great powers stood between Cyrus and mastery of the known world: Babylon, the ancient and magnificent city on the Euphrates, its walls counted among the wonders of the earth. In 539 BCE, Cyrus turned toward it.', fa: 'حالا تنها یکی از قدرت‌های بزرگ میان کوروش و فرمانروایی بر جهان شناخته‌شده قرار داشت: بابل، شهر باستانی و باشکوهی بر کرانه فرات، با دیوارهایی که از شگفتی‌های جهان به شمار می‌رفتند. در سال ۵۳۹ پیش از میلاد، کوروش به سوی آن روی آورد.' },
        ...
        { blocks: [
          { t: 'h', x: 'The Cyrus Cylinder', fa: 'استوانه کوروش' },
          ...
          { t: 'imgsm', key: 'cyrus-cylinder', cap: 'The Cyrus Cylinder, on which the king recorded his acts. It survives in the British Museum.', capFa: 'استوانه کوروش، که شاه اقدامات خود را بر آن ثبت کرد. این اثر امروز در موزه بریتانیا نگهداری می‌شود.' },
          { t: 'q', x: 'I returned to their places the gods who had dwelt there, and let them dwell in eternal abodes. I gathered all their peoples and restored to them their homes.', fa: 'خدایانی را که در آنجا می‌زیستند به جایگاه‌هایشان بازگرداندم و گذاشتم در جایگاه‌های جاودان خود سکونت کنند. همه مردمانشان را گرد آوردم و خانه‌هایشان را به آنان بازگرداندم.', by: 'the Cyrus Cylinder', byFa: 'استوانهٔ کوروش' },
        ] },
        { blocks: [
    ...
    },
    {
      ...
      pages: [
        { blocks: [
          { t: 'p', x: 'By now the empire of Cyrus stretched from the Aegean Sea in the west to the borders of India in the east, the largest the world had yet seen. But its true greatness lay not in its size. It lay in how he chose to rule it.', fa: 'تا آن زمان، امپراتوری کوروش از دریای اژه در غرب تا مرزهای هند در شرق گسترده شده بود؛ بزرگ‌ترین امپراتوری‌ای که جهان تا آن روز به خود دیده بود. اما عظمت واقعی آن در وسعتش نبود؛ در شیوه‌ای بود که کوروش برای فرمانروایی بر آن برگزیده بود.' },
          { t: 'imgwide', key: 'cyrus-empire', cap: 'The empire of Cyrus at its height, from the Aegean and Egypt to the Indus.', capFa: 'شاهنشاهی کوروش در اوج خود، از دریای اژه و مصر تا رود سند.' },
        ] },
        { blocks: [
          ...
          { t: 'steps', items: [
            { title: 'Tolerance of faith', titleFa: 'بردباری دینی', x: 'Every people was free to worship its own gods. Cyrus honored the temples of the lands he ruled.', fa: 'هر قوم آزاد بود خدایان خود را بپرستد. کوروش نیز به نیایشگاه‌های سرزمین‌هایی که بر آن‌ها فرمان می‌راند احترام می‌گذاشت.' },
    ...
    },
    {
      ...
      pages: [
        ...
        { blocks: [
          ...
          { t: 'imgrow', keys: ['cyrus-building-1', 'cyrus-building-2'], cap: 'The remains of Pasargadae, the capital Cyrus built, still standing on the Iranian plain.', capFa: 'بقایای پاسارگاد، پایتختی که کوروش بنا کرد، هنوز بر دشت ایران پابرجاست.' },
  ...
  chapters: [
    {
      ...
      pages: [
        { blocks: [
          { t: 'p', x: 'For centuries after the Mongol storm, Iran had been a patchwork of rival lords and warring tribes, with no single ruler and no single soul. Then, at the very dawn of the sixteenth century, a boy of fourteen changed the course of the nation forever.', fa: 'قرن‌ها پس از توفان مغول، ایران مجموعه‌ای پراکنده از فرمانروایان رقیب و ایل‌های در حال جنگ بود؛ نه فرمانروایی واحد داشت و نه هویتی یکپارچه. سپس، درست در سپیده‌دم سده شانزدهم، نوجوانی چهارده‌ساله مسیر تاریخ این ملت را برای همیشه دگرگون کرد.' },
          { t: 'p', x: 'His name was Ismail, and he was the young leader of the Safavid order, a devoted religious brotherhood from the northwest of Iran. Around him gathered fierce and loyal warriors, and at their head he swept across the land, defeating all who stood against him.', fa: 'نامش اسماعیل بود؛ پیشوای جوان طریقت صفوی، یک طریقت مذهبی پرشور از شمال‌غرب ایران. جنگاورانی دلیر و وفادار گرد او جمع شدند و او در رأس آنان سراسر سرزمین را درنوردید و هرکس را که در برابرش ایستاد شکست داد.' },
          { t: 'imgsm', key: 'safavid-ismail', cap: 'Shah Ismail I, founder of the Safavid dynasty, who took the throne at fourteen.', capFa: 'شاه اسماعیل یکم، بنیان‌گذار سلسله صفوی، که در چهارده‌سالگی بر تخت نشست.' },
        ] },
        { blocks: [
          { t: 'h', x: 'The crown at fourteen', fa: 'تاج در چهارده‌سالگی' },
          { t: 'p', x: 'In 1501 Ismail entered the city of Tabriz in triumph and had himself proclaimed Shah, the king of kings, taking the ancient title of the Persian monarchs. A boy still, he had founded a dynasty that would rule Iran for more than two centuries and restore it to greatness.', fa: 'در سال ۱۵۰۱، اسماعیل پیروزمندانه وارد تبریز شد و خود را شاه خواند؛ شاهنشاه، همان لقب کهنی که پادشاهان ایران از آن استفاده می‌کردند. هنوز نوجوان بود که سلسله‌ای بنیان گذاشت که بیش از دو قرن بر ایران فرمان راند و کشور را دوباره به جایگاه بزرگی رساند.' },
          { t: 'keyvalue', items: [
        ...
        { blocks: [
          ...
          { t: 'p', x: 'Ismail did something that would define Iran to this very day. He made Shia Islam the faith of his realm, setting Iran apart from its powerful Sunni neighbours and giving the nation a distinct religious identity that has endured for five hundred years.', fa: 'اسماعیل کاری کرد که تا امروز هویت ایران را شکل داده است. تشیع را آیین رسمی قلمرو خود قرار داد و بدین‌ترتیب ایران را از همسایگان نیرومند سنی‌مذهبش متمایز کرد؛ هویتی دینی و متمایز به این ملت بخشید که پانصد سال دوام آورده است.' },
          { t: 'p', x: 'It was a decision of enormous consequence. It unified the many peoples of Iran under one faith and one crown, forged a strong sense of a single nation, and shaped the character of the country for all the centuries that followed. Modern Iran, in its faith and its borders, was born in these years.', fa: 'این تصمیم پیامدهایی عظیم داشت. مردمان گوناگون ایران را زیر یک آیین و یک تاج متحد کرد، حس نیرومندی از تعلق به ملتی واحد پدید آورد و سیمای این کشور را برای همه قرن‌های پس از آن شکل داد. ایران امروز، هم در آیین و هم در مرزهایش، در همین سال‌ها زاده شد.' },
          { t: 'pull', x: 'From a fractured land, a single nation was reborn.', fa: 'از سرزمینی چندپاره، ملتی یکپارچه دوباره زاده شد.' },
        ] },
      ],
    },
    {
      ...
      pages: [
        { blocks: [
          { t: 'p', x: 'A reborn Iran did not go unchallenged. To the west lay the mighty Ottoman Empire, the greatest power of the age, and between the two great empires there began a long and bitter rivalry that would last for generations.', fa: 'ایرانِ دوباره‌زاده بی‌رقیب نماند. در غرب، امپراتوری نیرومند عثمانی قرار داشت؛ بزرگ‌ترین قدرت آن روزگار. میان این دو امپراتوری بزرگ، رقابتی دیرپا و تلخ آغاز شد که نسل‌ها ادامه یافت.' },
          { t: 'p', x: 'In 1514, at the battle of Chaldiran, the young Safavid state met the Ottomans in the field. The Ottomans had cannon and firearms, weapons the Safavid cavalry lacked, and the day went against Iran. It was a hard and early lesson that valour alone could not win a modern war.', fa: 'در سال ۱۵۱۴، در نبرد چالدران، دولت جوان صفوی در میدان نبرد با عثمانی‌ها روبه‌رو شد. عثمانی‌ها توپ و سلاح‌های آتشین داشتند، سلاح‌هایی که سواره‌نظام صفوی از آن‌ها بی‌بهره بود، و آن روز به زیان ایران تمام شد. این درسی سخت و زودهنگام بود: دلاوری به‌تنهایی نمی‌توانست یک جنگ مدرن را به پیروزی برساند.' },
        ] },
        { blocks: [
          { t: 'h', x: 'A kingdom tested', fa: 'پادشاهی در بوته آزمایش' },
          { t: 'p', x: 'The decades that followed were difficult ones. The dynasty was pressed on its frontiers by the Ottomans in the west and the Uzbeks in the east, and troubled at home by the rivalries of the powerful tribal chiefs on whom the throne depended.', fa: 'دهه‌های پس از آن دشوار بود. سلسله در مرزهایش از غرب زیر فشار عثمانی‌ها و از شرق زیر فشار ازبک‌ها قرار داشت و در داخل نیز گرفتار رقابت خان‌های نیرومند ایلی بود؛ همان‌هایی که تخت سلطنت به آنان تکیه داشت.' },
          { t: 'img', key: 'safavid-battle', cap: 'The Safavids faced the great powers of their age on every frontier.', capFa: 'صفویان در هر مرز با قدرت‌های بزرگ روزگار خود روبه‌رو بودند.' },
          { t: 'p', x: 'Yet the young state endured. Through hard years and capable rulers it held together, waiting, though it did not yet know it, for the king who would raise it to its height.', fa: 'با این همه، دولت جوان دوام آورد. در سال‌های سخت و به دست فرمانروایانی کاردان، یکپارچه ماند و چشم‌به‌راه ماند؛ هرچند خودش هنوز نمی‌دانست در انتظار چه کسی است: شاهی که آن را به اوج قدرت خواهد رساند.' },
        ] },
        { blocks: [
          { t: 'era', value: '1587', label: 'The year everything changed' },
          { t: 'p', x: 'In 1587 the throne passed to a prince who would become the greatest of all the Safavid kings, and one of the greatest rulers in the whole history of Iran. His name was Abbas.', fa: 'در سال ۱۵۸۷، تخت به شاهزاده‌ای رسید که بزرگ‌ترین پادشاه صفوی و یکی از بزرگ‌ترین فرمانروایان در سراسر تاریخ ایران شد. نامش عباس بود.' },
        ] },
      ],
    },
    {
      ...
      pages: [
        { blocks: [
          { t: 'p', x: 'Shah Abbas came to the throne of a troubled kingdom, hemmed in by enemies and weakened by division within. Over the course of his long reign he transformed it utterly, and left Iran stronger, richer, and more glorious than it had been in a thousand years.', fa: 'شاه عباس بر تخت پادشاهی‌ای نشست که گرفتار مشکلات بود؛ از بیرون در محاصره دشمنان و از درون تضعیف‌شده بر اثر تفرقه. در طول سلطنت طولانی‌اش آن را یکسره دگرگون کرد و ایران را نیرومندتر، ثروتمندتر و باشکوه‌تر از آنچه در هزار سال گذشته بود، بر جای گذاشت.' },
          { t: 'imgsm', key: 'safavid-abbas', cap: 'Shah Abbas the Great, under whom the Safavid Empire reached its height.', capFa: 'شاه عباس بزرگ، که شاهنشاهی صفوی در روزگار او به اوج خود رسید.' },
          { t: 'p', x: 'He was a ruler of rare gifts: a brilliant soldier, a shrewd statesman, and a great patron of art and architecture. He was also, at times, a hard and suspicious man, as the great kings of that age often were. But his vision for Iran was without equal.', fa: 'فرمانروایی بود با توانایی‌هایی کم‌نظیر: سربازی درخشان، سیاستمداری زیرک و حامی بزرگ هنر و معماری. گاه نیز مردی سختگیر و بدگمان بود، چنان‌که پادشاهان بزرگ آن روزگار اغلب چنین بودند. اما چشم‌اندازی که برای ایران داشت، بی‌همتا بود.' },
        ] },
        { blocks: [
          { t: 'h', x: 'The remaking of an army', fa: 'بازسازی یک ارتش' },
          { t: 'p', x: 'Abbas understood the lesson of Chaldiran. He built a new standing army, no longer dependent on the fickle tribal cavalry, equipped with muskets and cannon in the modern way. With it he became master in his own house and a match for his enemies abroad.', fa: 'عباس درس چالدران را به‌خوبی دریافته بود. ارتشی تازه و دائمی ساخت که دیگر به سواره‌نظام متزلزل ایلی وابسته نبود و به شیوه‌ای مدرن به تفنگ و توپ مجهز شده بود. با این ارتش، هم در داخل کشور اختیار امور را به دست گرفت و هم در برابر دشمنان خارجی به رقیبی قدرتمند تبدیل شد.' },
          { t: 'p', x: 'Then he turned that army against the empires that had pressed Iran for so long. He drove back the Uzbeks in the east, and he won back from the Ottomans the great western lands they had taken, restoring Iran to its full strength and its rightful borders.', fa: 'سپس همین ارتش را علیه امپراتوری‌هایی به کار گرفت که سال‌ها بر ایران فشار آورده بودند. ازبکان را در شرق عقب راند و سرزمین‌های پهناور غربی را که عثمانیان گرفته بودند بازپس گرفت و ایران را به توان کامل و مرزهای تاریخی‌اش بازگرداند.' },
          { t: 'steps', items: [
            { title: 'A modern army', titleFa: 'ارتشی مدرن', x: 'A standing force with muskets and cannon, loyal to the crown alone.', fa: 'نیرویی دائمی، مجهز به تفنگ و توپ، که تنها به تاج‌وتخت وفادار بود.' },
            ...
            { title: 'Trade and wealth', titleFa: 'تجارت و ثروت', x: 'He welcomed merchants from across the world and made Iran rich.', fa: 'از بازرگانان سراسر جهان استقبال کرد و ایران را ثروتمند کرد.' },
            { title: 'A new capital', titleFa: 'پایتختی تازه', x: 'He made Isfahan his capital and adorned it beyond compare.', fa: 'اصفهان را پایتخت خود کرد و آن را چنان آراست که در زیبایی همتایی نداشت.' },
          ] },
        ] },
        { blocks: [
          { t: 'h', x: 'A door opened to the world', fa: 'دری رو به جهان گشوده شد' },
          { t: 'p', x: 'Abbas welcomed the world to Iran. He invited European merchants and ambassadors, encouraged the silk trade that was the treasure of his realm, and made his country a crossroads of commerce between East and West. Iranian silk and carpets travelled to the courts of Europe, and the wealth of the world flowed into Iran.', fa: 'عباس جهان را به روی ایران گشود. بازرگانان و سفیران اروپایی را دعوت کرد، تجارت ابریشم را که گنج قلمرو او بود رونق بخشید و کشورش را به چهارراه بازرگانی میان شرق و غرب تبدیل کرد. ابریشم و فرش ایرانی به دربارهای اروپا راه یافت و ثروت جهان به سوی ایران سرازیر شد.' },
          { t: 'p', x: 'Under his hand, Iran was not only strong but prosperous, respected among the great powers of the earth, and open to the world in a way it had not been for centuries.', fa: 'در دوران او، ایران نه‌تنها نیرومند، بلکه آباد و ثروتمند بود؛ در میان قدرت‌های بزرگ جهان احترام داشت و به روی جهان گشوده بود، آن‌گونه که قرن‌ها چنین نبود.' },
        ] },
      ],
    },
    {
      ...
      pages: [
        { blocks: [
          { t: 'p', x: 'Of all that Shah Abbas achieved, none endures more beautifully than his capital. He made Isfahan the seat of his empire and set out to make it the most beautiful city on earth, and by the judgment of many who saw it, he succeeded.', fa: 'از میان همه دستاوردهای شاه عباس، هیچ‌کدام به زیبایی پایتختش ماندگار نشده است. اصفهان را پایتخت امپراتوری خود کرد و بر آن شد تا آن را زیباترین شهر روی زمین بسازد؛ و به گواه بسیاری از کسانی که آن را دیده بودند، در این کار موفق شد.' },
          { t: 'img', key: 'safavid-isfahan', cap: 'Isfahan, the capital of Shah Abbas, one of the most beautiful cities ever built.', capFa: 'اصفهان، پایتخت شاه عباس، یکی از زیباترین شهرهایی که تاکنون ساخته شده است.' },
          { t: 'p', x: 'So great was its splendour that a saying arose, repeated by travellers across the world, that captured the wonder of all who beheld it.', fa: 'شکوهش چنان بود که سخنی بر سر زبان‌ها افتاد؛ جمله‌ای که مسافران از سراسر جهان آن را تکرار می‌کردند و شگفتی همه کسانی را که شهر را می‌دیدند به‌خوبی بیان می‌کرد.' },
        ] },
        { blocks: [
          { t: 'quotebig', x: 'Isfahan is half the world.', fa: 'اصفهان نصف جهان است.', by: 'A SAYING OF THE AGE', byFa: 'ضرب‌المثلی از آن روزگار' },
          { t: 'p', x: 'At the heart of the city he laid out a vast royal square, the Naqsh-e Jahan, the Image of the World, one of the largest and most magnificent public squares ever built. Around it he raised buildings of such beauty that they remain, to this day, among the treasures of all humanity.', fa: 'در قلب شهر، میدان شاهی پهناوری بنا کرد: نقش جهان، «تصویر جهان»، یکی از بزرگ‌ترین و باشکوه‌ترین میدان‌های عمومی که تا آن زمان ساخته شده بود. پیرامون آن بناهایی ساخت چنان زیبا که هنوز هم در شمار گنجینه‌های بشریت‌اند.' },
        ] },
        { blocks: [
          { t: 'h', x: 'Wonders in tile and stone', fa: 'شگفتی‌هایی از کاشی و سنگ' },
          { t: 'p', x: 'On the square rose the great Shah Mosque, its dome and portals covered in dazzling blue tilework, a masterpiece of Persian architecture. Nearby stood the exquisite Sheikh Lotfollah Mosque, the graceful Ali Qapu palace, and the entrance to the endless royal bazaar.', fa: 'در میدان، مسجد بزرگ شاه سر برآورد؛ گنبد و سردرهایش پوشیده از کاشی‌کاری‌های خیره‌کننده آبی‌رنگ، شاهکاری از معماری ایرانی. در همان نزدیکی، مسجد ظریف و چشم‌نواز شیخ لطف‌الله، کاخ باشکوه عالی‌قاپو و سردر بازار بزرگ و بی‌پایان شاهی قرار داشت.' },
  ...
  chapters: [
    {
      ...
      pages: [
        { blocks: [
          { t: 'p', x: 'After the gentle Zand dynasty fell, a harder power rose to take its place. Agha Mohammad Khan, chief of the Qajar tribe of the north, fought his way to mastery over Iran and had himself crowned Shah in the last years of the eighteenth century.', fa: 'پس از فروپاشی سلسله زند، قدرتی سخت‌تر جای آن را گرفت. آقامحمدخان، سرکرده ایل قاجار در شمال، با جنگ و نبرد راه خود را به فرمانروایی بر ایران باز کرد و در واپسین سال‌های سده هجدهم تاج شاهی بر سر گذاشت.' },
          { t: 'p', x: 'He was a ruler of iron will and, by all accounts, fearsome cruelty, forged in a lifetime of struggle and captivity. But he reunited a country that had again fallen into division, and he founded a dynasty that would rule Iran for well over a century.', fa: 'فرمانروایی بود با اراده‌ای آهنین و، به روایت‌های مختلف، بی‌رحمی‌ای هولناک؛ شخصیتی که یک عمر کشمکش و اسارت او را چنین ساخته بود. اما کشوری را که دوباره دچار تفرقه شده بود یکپارچه کرد و سلسله‌ای بنیان گذاشت که بیش از یک قرن بر ایران فرمان راند.' },
        ...
        { blocks: [
          ...
          { t: 'p', x: 'It was the Qajars who chose as their capital a modest town in the north of Iran, one that would grow, over their long rule and the ages after, into the great metropolis of the nation. That town was Tehran, and it has been the heart of Iran ever since.', fa: 'این قاجارها بودند که شهرکی ساده در شمال ایران را به پایتختی برگزیدند؛ شهرکی که در طول فرمانروایی طولانی آنان و در سال‌های پس از آن، به کلان‌شهر بزرگ کشور تبدیل شد. آن شهرک تهران بود و از آن زمان تاکنون قلب ایران بوده است.' },
          { t: 'markline', x: 'Under the Qajars, Tehran became the capital it remains to this day.', fa: 'در دوره قاجار، تهران به پایتخت تبدیل شد و تا امروز پایتخت ایران مانده است.' },
          { t: 'p', x: 'The crown passed to Fath Ali Shah, whose long reign was famous for its splendour and ceremony, its jewelled court and its portraits of a bearded king in golden robes. But beyond the glitter of the court, storm clouds were gathering on the horizon.', fa: 'تاج شاهی به فتحعلی‌شاه رسید؛ شاهی که دوران طولانی سلطنتش به شکوه و تشریفات، دربار آراسته به جواهرات و تصویرهای شاهی ریش‌دار با جامه‌های زرین شهرت داشت. اما آن‌سوی زرق‌وبرق دربار، ابرهای توفان در افق در حال جمع شدن بودند.' },
        ] },
      ],
    },
    {
      ...
      pages: [
        { blocks: [
          { t: 'p', x: 'The nineteenth century was the age of the great European empires, and Iran found itself caught between two of the hungriest. To the north loomed the vast and expanding empire of Russia. To the east and south stretched the power of the British, masters of India.', fa: 'سده نوزدهم، عصر امپراتوری‌های بزرگ اروپایی بود و ایران خود را گرفتار میان دو تا از توسعه‌طلب‌ترین آن‌ها دید. در شمال، امپراتوری پهناور و رو به گسترش روسیه قد علم کرده بود. در شرق و جنوب، قدرت بریتانیا گسترده بود؛ قدرتی که بر هند فرمان می‌راند.' },
          { t: 'p', x: 'Between these two giants, Iran was squeezed, courted, and pressured, its fate bound up in a great game of empires that it had not the strength to control. It was a hard and humbling position for a proud and ancient nation.', fa: 'ایران میان این دو غول، تحت فشار بود، هر دو طرف می‌کوشیدند دلش را به دست بیاورند و هم‌زمان بر آن فشار می‌آوردند؛ سرنوشتش به بازی بزرگ امپراتوری‌ها گره خورده بود، بازی‌ای که توان کنترلش را نداشت. برای ملتی سربلند و کهن، جایگاهی سخت و تحقیرآمیز بود.' },
        ] },
        { blocks: [
          { t: 'h', x: 'The wars with Russia', fa: 'جنگ‌های ایران و روسیه' },
          { t: 'p', x: 'Twice in the early century Iran went to war with Russia over the lands of the Caucasus, and twice it was defeated by the superior arms and organization of the Russian armies. The cost of those defeats was severe, and it was paid in Iranian soil.', fa: 'در سال‌های آغازین آن قرن، ایران دو بار بر سر سرزمین‌های قفقاز با روسیه وارد جنگ شد و هر دو بار، در برابر سلاح‌ها و سازمان‌دهی برتر ارتش روسیه شکست خورد. بهای این شکست‌ها سنگین بود و با از دست رفتن بخشی از خاک ایران پرداخت شد.' },
          { t: 'numstat', items: [
        ...
        { blocks: [
          ...
          { t: 'markline', x: 'A proud nation learned, painfully, that valour alone could not stand against modern empires.', fa: 'ملتی سربلند، به تلخی آموخت که دلاوری به‌تنهایی در برابر امپراتوری‌های مدرن کافی نیست.' },
        ] },
      ],
    },
    {
      ...
      pages: [
        { blocks: [
          { t: 'p', x: 'Not everyone accepted Iran\'s decline. In the middle of the century there rose a man who saw clearly what his country needed, and who tried, in a few short years, to drag it into the modern world. His name was Amir Kabir, and he was the chief minister of the young Shah, Naser al-Din.', fa: 'همه افول ایران را نپذیرفتند. در میانه آن قرن، مردی برخاست که به‌روشنی می‌دید کشورش به چه نیاز دارد و کوشید در چند سال کوتاه، آن را به جهان مدرن وارد کند. نامش امیرکبیر بود؛ صدراعظم شاه جوان، ناصرالدین‌شاه.' },
        ...
        { blocks: [
          { t: 'h', x: 'A vision of a modern Iran', fa: 'چشم‌اندازی از ایران مدرن' },
          ...
          { t: 'duo', left: { title: 'His vision', titleFa: 'چشم‌انداز او', x: 'A modern, independent, educated Iran, strong enough to stand on its own among the nations.' }, right: { title: 'His enemies', titleFa: 'دشمنانش', x: 'A jealous court that feared his power and honesty, and whispered against him to the young king.' } },
        ] },
        { blocks: [
          { t: 'p', x: 'But his very success made him enemies. The courtiers whose corruption he threatened, and who feared his influence over the young Shah, turned the king against him. In 1851 he was dismissed, exiled, and soon after put to death on the Shah\'s order, in a bath house in Kashan.', fa: 'اما همین موفقیت برایش دشمن تراشید. درباریانی که فسادشان را در خطر می‌دیدند و از نفوذ او بر شاه جوان می‌ترسیدند، شاه را علیه او برانگیختند. در سال ۱۲۳۰ خورشیدی، از کار برکنار و تبعید شد و اندکی بعد، به فرمان شاه، در حمام فین کاشان به قتل رسید.' },
          { t: 'markline', x: 'Iran lost, in one stroke, the greatest reformer of its age. It is one of history\'s saddest what-ifs.', fa: 'ایران در یک لحظه بزرگ‌ترین اصلاحگر روزگار خود را از دست داد. این یکی از غم‌انگیزترین «اگر»های تاریخ است.' },
          { t: 'p', x: 'What Iran might have become, had Amir Kabir been allowed to finish his work, is one of the great questions of the nation\'s history. His death was a tragedy, and the reforms he began were largely undone.', fa: 'اینکه اگر می‌گذاشتند امیرکبیر کارش را به پایان برساند، ایران چه می‌توانست بشود، یکی از پرسش‌های بزرگ تاریخ این ملت است. مرگش یک تراژدی بود و بیشتر اصلاحاتی که آغاز کرده بود، از میان رفت.' },
        ] },
      ],
    },
    {
      ...
      pages: [
        { blocks: [
          { t: 'p', x: 'As the century wore on, the kings sold ever more of the nation\'s wealth and rights to foreign powers and companies, granting concessions over tobacco, banking, oil, and more, to fill an empty treasury. But the people of Iran were beginning to stir.', fa: 'هرچه قرن پیش می‌رفت، شاهان بخش بیشتری از ثروت و حقوق این ملت را به قدرت‌ها و شرکت‌های بیگانه واگذار می‌کردند؛ امتیاز تنباکو، بانک، نفت و بسیاری چیزهای دیگر را می‌فروختند تا خزانه تهی را پر کنند. اما مردم ایران کم‌کم داشتند به حرکت درمی‌آمدند.' },
          { t: 'h', x: 'The Tobacco Protest', fa: 'نهضت تنباکو' },
          ...
          { t: 'markline', x: 'For the first time, the people had spoken with one voice, and the throne had been made to listen.', fa: 'برای نخستین بار، مردم یکصدا سخن گفته بودند و شاه ناچار شده بود صدای آنها را بشنود.' },
        ] },
        { blocks: [
          { t: 'h', x: 'The Constitutional Revolution', fa: 'انقلاب مشروطه' },
          { t: 'p', x: 'The Tobacco Protest was only the beginning. The demand grew for a government of laws rather than the whim of kings, and in 1906 the movement triumphed. The Shah was compelled to grant a constitution and to establish the Majles, the national parliament, the first in Iranian history.', fa: 'نهضت تنباکو تنها آغاز کار بود. خواستِ برپایی حکومتی بر پایه قانون، به‌جای اراده و هوس شاهان، روزبه‌روز بیشتر شد و در سال ۱۲۸۵ خورشیدی این جنبش به پیروزی رسید. شاه ناچار شد فرمان مشروطیت را صادر کند و مجلس شورای ملی را برپا سازد؛ نخستین مجلس در تاریخ ایران.' },
          { t: 'ribbon', items: [
        ...
        { blocks: [
          ...
          { t: 'markline', x: 'A nation had awoken to the idea that it belonged to its people.', fa: 'ملتی بیدار شده بود و به این باور رسیده بود که کشورش از آنِ مردم است.' },
        ] },
      ],
    },
    {
      ...
      pages: [
        ...
        { blocks: [
          ...
          { t: 'markline', x: 'The Qajar century closed, and the Pahlavi age of modern Iran began.', fa: 'قرن قاجار به پایان رسید و دوران پهلوی و ایران مدرن آغاز شد.' },
        ] },
        { blocks: [
          { t: 'div' },
          ...
          { t: 'p', x: 'From the trials of the Qajar century, a new and modern Iran was struggling to be born. And when at last it emerged, it would carry forward both the wounds and the awakenings of these long and difficult years.', fa: 'از دل سختی‌ها و آزمون‌های قرن قاجار، ایرانی تازه و مدرن در تلاش بود تا متولد شود. و وقتی سرانجام سر برآورد، هم زخم‌های این سال‌های طولانی و دشوار را با خود به آینده برد و هم بیداری‌هایی را که در همین دوران شکل گرفته بود.' },
          { t: 'pull', x: 'In its century of hardship, the nation found its own voice.', fa: 'ملت در قرنِ سختی، صدای خودش را پیدا کرد.' },
        ] },
      ],
    },
  ],
...
const sasanian: Topic = {
  ...
  chapters: [
    {
      key: 'ss1',
      title: 'The Rebirth of Persia', titleFa: 'زایش دوباره ایران',
      subtitle: '224 CE',
      pages: [
        { blocks: [
          { t: 'p', x: 'For nearly five centuries after Alexander, the glory of Cyrus and Darius had faded. Iran was ruled first by Greek kings and then by the Parthians, a capable but loosely bound dynasty. The memory of the great Persian Empire lived on, but its full splendour had dimmed.', fa: 'نزدیک به پنج قرن پس از اسکندر، شکوه کوروش و داریوش رنگ باخته بود. بر ایران نخست شاهان یونانی فرمان راندند و سپس اشکانیان، سلسله‌ای کاردان اما نه‌چندان یکپارچه. یاد امپراتوری بزرگ ایران زنده مانده بود، اما شکوه و درخشش آن دیگر مانند گذشته نبود.' },
          { t: 'p', x: 'Then, in 224 CE, a prince from the south, from the very heartland of Persia where Cyrus had once ruled, rose up and restored the ancient glory. His name was Ardashir, and he founded the Sasanian dynasty, the last and one of the greatest of the pre-Islamic Persian empires.', fa: 'سپس، در سال ۲۲۴ میلادی، شاهزاده‌ای از جنوب، از همان قلب سرزمین پارس که روزگاری کوروش بر آن فرمان می‌راند، برخاست و شکوه باستانی را بازگرداند. نامش اردشیر بود و سلسله ساسانی را بنیان نهاد؛ واپسین و یکی از بزرگ‌ترین امپراتوری‌های ایران پیش از اسلام.' },
          { t: 'splitimg', key: 'sasanian-ardashir', title: 'Ardashir I', titleFa: 'اردشیر یکم', x: 'Ardashir overthrew the Parthians and founded a new empire that consciously looked back to the Achaemenids of Cyrus and Darius, seeking to restore the true glory of Persia.', fa: 'اردشیر اشکانیان را برانداخت و امپراتوری تازه‌ای بنیان نهاد که آگاهانه به هخامنشیانِ کوروش و داریوش چشم داشت و می‌کوشید شکوه راستین ایران را بازگرداند.' },
        ] },
        { blocks: [
          { t: 'h', x: 'A conscious return to greatness', fa: 'بازگشتی آگاهانه به بزرگی' },
          { t: 'p', x: 'The Sasanians saw themselves as the true heirs of the ancient Persian kings. They revived the old titles, the old glory, and the old faith, and set out to build an empire worthy of the Achaemenid name. Under them, Persia was reborn as a great power of the world.', fa: 'ساسانیان خود را وارثان راستین شاهان باستانی ایران می‌دانستند. لقب‌های کهن، شکوه گذشته و آیین کهن را زنده کردند و بر آن شدند امپراتوری‌ای بسازند که درخور نام هخامنشی باشد. در روزگار آنان، ایران دوباره به قدرتی بزرگ در جهان تبدیل شد.' },
          { t: 'markline', x: 'After five centuries, the true glory of Persia rose again.', fa: 'پس از پنج قرن، شکوه راستین ایران دوباره سر برآورد.' },
    ...
    },
    {
      ...
      pages: [
        { blocks: [
          { t: 'p', x: 'At the very heart of the Sasanian world lay a faith of great antiquity and beauty: Zoroastrianism, the religion of the prophet Zarathustra, which the Persians had followed for more than a thousand years. Under the Sasanians it became the official faith of the empire, woven into the state itself.', fa: 'در قلب جهان ساسانی، آیینی کهن و زیبا جای داشت: آیین زرتشتی، دین زرتشت پیامبر، که ایرانیان بیش از هزار سال به آن باور داشتند. در روزگار ساسانیان، این آیین به دین رسمی امپراتوری تبدیل شد و با ساختار حکومت درهم آمیخت.' },
          { t: 'p', x: 'It is one of the oldest revealed religions in the world, and among the most influential. It taught of a single supreme God, Ahura Mazda, the Wise Lord, and of the eternal struggle between truth and light on one side, and falsehood and darkness on the other, a struggle in which every person must choose their part.', fa: 'این آیین یکی از کهن‌ترین ادیان وحیانی جهان و از اثرگذارترین آنهاست. از خدای یگانه و برتری به نام اهورامزدا، خداوند دانا، سخن می‌گفت و از نبردی جاودانه میان راستی و روشنایی از یک سو و دروغ و تاریکی از سوی دیگر؛ نبردی که هر انسان باید در آن جایگاه خود را انتخاب کند.' },
        ] },
        { blocks: [
        ...
        { blocks: [
          ...
          { t: 'call', title: 'A faith worthy of its own telling', titleFa: 'آیینی که شایسته روایتی جداگانه است', x: 'Zoroastrianism is one of the great treasures of Iranian heritage, and its full story, its prophet, its scripture, and its enduring influence, deserves a telling all its own, which it will one day have.', fa: 'آیین زرتشتی یکی از گنجینه‌های بزرگ میراث ایرانی است و داستان کامل آن، از پیامبر و کتاب مقدسش گرفته تا تأثیر ماندگارش، شایسته روایتی جداگانه است؛ روایتی که روزی به آن خواهیم پرداخت.' },
        ] },
      ],
    },
    {
      ...
      pages: [
        { blocks: [
          { t: 'p', x: 'For over four hundred years, the Sasanian Empire stood as the great rival of Rome, and later of its successor, the Byzantine Empire. These were the two superpowers of the ancient world, and between them stretched a frontier contested in war after war across the centuries.', fa: 'بیش از چهارصد سال، شاهنشاهی ساسانی رقیب بزرگ روم و سپس جانشین آن، امپراتوری بیزانس، بود. این دو ابرقدرت جهان باستان بودند و میانشان مرزی قرار داشت که قرن‌ها جنگ پس از جنگ بر سر آن درگرفت.' },
        ...
        { blocks: [
          { t: 'splitimg', key: 'sasanian-shapur', title: 'Shapur I', titleFa: 'شاپور یکم', x: 'Shapur the Great defeated three Roman emperors and captured one, Valerian, in battle. His victories are carved into the rock reliefs of Persia, where they endure to this day.', fa: 'شاپور بزرگ سه امپراتور روم را شکست داد و یکی از آنها، والرین، را در نبرد به اسارت گرفت. پیروزی‌های او بر نقش‌برجسته‌های سنگی ایران حک شده و تا امروز بر جا مانده‌اند.' },
          { t: 'numstat', items: [
            { n: '3', label: 'Roman emperors defeated by Shapur I', labelFa: 'امپراتوران روم که شاپور یکم شکست داد' },
            { n: '260 CE', nFa: '۲۶۰ م', label: 'The Roman emperor Valerian captured', labelFa: 'اسارت والرین، امپراتور روم' },
            { n: '400+', label: 'Years as a great world power', labelFa: 'سال‌ها در جایگاه یک قدرت بزرگ جهانی' },
            { n: 'Rome', nFa: 'روم', label: 'Its equal and rival for centuries', labelFa: 'همتای آن و رقیبش در طول قرن‌ها' },
          ] },
        ] },
        { blocks: [
          { t: 'h', x: 'A golden age of civilization', fa: 'عصر طلایی یک تمدن' },
          { t: 'p', x: 'The Sasanian centuries were a golden age of Persian civilization. Their capital, Ctesiphon, was one of the greatest cities in the world, home to the mighty arch of Taq Kasra, the largest brick vault ever built, which still stands after seventeen hundred years.', fa: 'قرن‌های ساسانی عصر طلایی تمدن ایرانی بود. پایتختشان، تیسفون، یکی از بزرگ‌ترین شهرهای جهان به شمار می‌رفت و طاق سترگ کسری را در خود جای داده بود؛ بزرگ‌ترین طاق آجری که تا آن زمان ساخته شده بود و پس از هزار و هفتصد سال هنوز پابرجاست.' },
          ...
          { t: 'markline', x: 'From Rome to China, the world knew the splendour of Sasanian Persia.', fa: 'از روم تا چین، جهان شکوه و عظمت ایران ساسانی را می‌شناخت.' },
        ] },
      ],
    },
    {
      key: 'ss4',
      title: 'The Last Glory and the Long War', titleFa: 'واپسین شکوه و جنگی طولانی',
      subtitle: '531 - 628 CE',
      pages: [
        { blocks: [
          { t: 'p', x: 'The empire reached its final height under the great king Khosrow the First, remembered as Anushirvan, the Immortal Soul, a byword for justice and wisdom for centuries after. Under him the empire was reformed, learning flourished, and Persia stood at the very peak of its power and prestige.', fa: 'امپراتوری در روزگار خسرو یکم به واپسین اوج خود رسید؛ پادشاه بزرگی که او را انوشیروان، به معنای «روان جاودان»، می‌خواندند و نامش قرن‌ها نماد دادگری و خرد بود. در دوران او، امپراتوری اصلاح شد، دانش رونق گرفت و ایران به اوج قدرت و اعتبار خود رسید.' },
          { t: 'splitimg', key: 'sasanian-khosrow', title: 'Khosrow Anushirvan', titleFa: 'خسرو انوشیروان', x: 'Khosrow the First was remembered across the East as the model of the just and wise king. Under him, Sasanian Persia reached its golden height.', fa: 'خسرو یکم در سراسر شرق به‌عنوان نمونهٔ شاهی دادگر و خردمند شناخته می‌شد. در روزگار او، ایران ساسانی به اوج عصر طلایی خود رسید.' },
        ] },
        { blocks: [
          ...
          { t: 'ribbon', items: [
            ...
            { year: '614', label: 'Persia conquers Jerusalem and the Holy Land', labelFa: 'ایران اورشلیم و سرزمین مقدس را فتح می‌کند' },
        ...
        { blocks: [
          { t: 'p', x: 'Then the tide turned. The Byzantine emperor struck back and carried the war deep into the heart of Persia. When at last the fighting ended, after twenty six years, both great empires were utterly exhausted, their treasuries empty, their armies bled white, their people weary of endless war.', fa: 'سپس ورق برگشت. امپراتور بیزانس ضدحمله زد و جنگ را تا قلب ایران پیش برد. وقتی سرانجام پس از بیست‌وشش سال نبرد پایان یافت، هر دو امپراتوری بزرگ یکسره از پا افتاده بودند؛ خزانه‌ها تهی، سپاه‌ها تحلیل‌رفته و مردم از جنگ بی‌پایان خسته شده بودند.' },
          { t: 'markline', x: 'The two great powers of the world had fought each other to the point of ruin.', fa: 'دو قدرت بزرگ جهان آن‌قدر با یکدیگر جنگیده بودند که هر دو را تا مرز ویرانی پیش برده بودند.' },
          { t: 'p', x: 'Neither empire knew it, but a new power was rising in the deserts of Arabia to the south, one that would sweep away the exhausted old order and change the world forever.', fa: 'هیچ‌یک از دو امپراتوری از آن خبر نداشت، اما در بیابان‌های عربستان در جنوب، قدرتی تازه در حال سر برآوردن بود؛ قدرتی که نظم کهنه و فرسوده را از میان می‌برد و جهان را برای همیشه دگرگون می‌کرد.' },
        ] },
      ],
    },
    {
      key: 'ss5',
      title: 'The Coming of Islam', titleFa: 'ظهور اسلام',
      subtitle: '633 - 651 CE',
      pages: [
        { blocks: [
          { t: 'p', x: 'In the deserts of Arabia, a new faith had been born. Islam had united the Arab tribes as never before, and filled them with a burning purpose. In the 630s, the armies of the young Muslim state burst out of Arabia, and they turned toward the two exhausted empires to the north.', fa: 'در بیابان‌های عربستان، آیینی تازه زاده شده بود. اسلام قبایل عرب را چنان که پیش از آن هرگز نشده بود متحد کرد و آنان را از آرمانی سوزان سرشار ساخت. در دههٔ ۶۳۰ میلادی، سپاهیان دولت جوان مسلمان از عربستان بیرون آمدند و رو به دو امپراتوری خسته در شمال نهادند.' },
          { t: 'p', x: 'The Sasanian Empire, drained by its long war with Byzantium and weakened by years of turmoil at its court, was not the power it had been. Yet few could have imagined how swiftly the ancient empire would fall.', fa: 'امپراتوری ساسانی که جنگ طولانی با بیزانس توانش را فرسوده و سال‌ها آشوب در دربارش آن را تضعیف کرده بود، دیگر آن قدرت سابق نبود. با این همه، کمتر کسی می‌توانست تصور کند که این امپراتوری کهن با چه سرعتی فرو خواهد ریخت.' },
        ] },
        { blocks: [
          { t: 'h', x: 'The battle that decided an empire', fa: 'نبردی که سرنوشت یک امپراتوری را رقم زد' },
          { t: 'p', x: 'The decisive blow came at the battle of Qadisiyyah, around the year 636, where the main Sasanian army met the Arab forces. After days of hard fighting, the Persian army was broken. The road to the capital lay open, and the great city of Ctesiphon fell to the conquerors.', fa: 'ضربهٔ سرنوشت‌ساز در نبرد قادسیه، حدود سال ۶۳۶ میلادی، فرود آمد؛ جایی که سپاه اصلی ساسانی با نیروهای عرب روبه‌رو شد. پس از روزها نبرد سخت، سپاه ایران درهم شکست. راه پایتخت باز شد و شهر بزرگ تیسفون به دست فاتحان افتاد.' },
          { t: 'numstat', items: [
            { n: '636', label: 'The battle of Qadisiyyah breaks the Persian army', labelFa: 'نبرد قادسیه سپاه ایران را درهم می‌شکند' },
            { n: '637', label: 'The capital, Ctesiphon, falls', labelFa: 'پایتخت، تیسفون، سقوط می‌کند' },
            { n: '642', label: 'The battle of Nahavand, the final defeat', labelFa: 'نبرد نهاوند، شکست نهایی' },
            { n: '651', label: 'The last Sasanian king dies; the empire ends', labelFa: 'واپسین شاه ساسانی می‌میرد؛ امپراتوری پایان می‌یابد' },
          ] },
        ] },
        { blocks: [
          ...
          { t: 'markline', x: 'An empire that had rivalled Rome for four hundred years had fallen in a single generation.', fa: 'امپراتوری‌ای که چهارصد سال با روم رقابت کرده بود، در فاصلهٔ یک نسل فرو ریخت.' },
        ] },
        { blocks: [
          { t: 'div' },
          ...
          { t: 'pull', x: 'The empire fell, but the soul of Iran endured, and would one day speak again.', fa: 'امپراتوری فرو ریخت، اما جان ایران پابرجا ماند و روزی دوباره به سخن درآمد.' },
        ] },
      ],
    },
  ],
...
const silence: Topic = {
  ...
  chapters: [
    ...
    {
      key: 'tc2',
      title: 'The Soul That Would Not Die', titleFa: 'جانی که تن به مرگ نداد',
      ...
      pages: [
        { blocks: [
          ...
          { t: 'markline', x: 'They took our throne, but they could not take our language, nor our memory.', fa: 'تخت ما را گرفتند، اما نتوانستند زبان و خاطرهٔ ما را از ما بگیرند.' },
        ...
        { blocks: [
          { t: 'h', x: 'The stirrings of revival', fa: 'نخستین نشانه‌های بیداری' },
          ...
          { t: 'ribbon', items: [
            ...
            { year: '750', label: 'A new age dawns; Persian influence rises again', labelFa: 'عصر تازه‌ای آغاز می‌شود؛ نفوذ ایران دوباره اوج می‌گیرد' },
            { year: '820', label: 'Persian dynasties rule once more in the east', labelFa: 'سلسله‌های ایرانی بار دیگر در شرق فرمان می‌رانند' },
            { year: '900', label: 'The Persian language and spirit begin to bloom anew', labelFa: 'زبان و روح ایرانی دوباره جان می‌گیرند و شکوفا می‌شوند' },
          ] },
        ] },
      ],
    },
    {
      ...
      pages: [
        { blocks: [
          { t: 'p', x: 'Every people needs a voice to speak its soul, and Iran found hers in one of the greatest poets who ever lived. In the eastern city of Tus, a nobleman set himself a task that would consume more than thirty years of his life, and that would give Iran back its very self.', fa: 'هر ملتی به صدایی نیاز دارد تا جانش را به زبان بیاورد، و ایران این صدا را در یکی از بزرگ‌ترین شاعران تاریخ یافت. در شهر توس، در شرق ایران، مردی از خاندان دهقانان کاری را بر عهده گرفت که بیش از سی سال از عمرش را گرفت و قرار بود ایران را دوباره به خودش بازگرداند.' },
          ...
          { t: 'splitimg', key: 'silence-ferdowsi', title: 'Ferdowsi of Tus', titleFa: 'فردوسیِ توس', x: 'For over thirty years Ferdowsi labored on the Shahnameh, giving his life to preserve the stories, and the language, of his people.', fa: 'فردوسی بیش از سی سال برای سرودن شاهنامه رنج برد و عمر خود را وقف حفظ داستان‌ها و زبان مردمش کرد.' },
        ] },
        { blocks: [
          { t: 'h', x: 'A book to hold a nation', fa: 'کتابی که ملتی را در خود نگاه داشت' },
          { t: 'p', x: 'The Shahnameh is one of the longest and greatest epic poems ever composed by a single hand, nearly sixty thousand verses, a whole world of kings and warriors, love and war, tragedy and glory. But it was far more than a collection of stories. It was an act of preservation, and of defiance.', fa: 'شاهنامه یکی از بلندترین و بزرگ‌ترین حماسه‌هایی است که به دست یک شاعر سروده شده؛ نزدیک به شصت هزار بیت، جهانی کامل از شاهان و پهلوانان، عشق و جنگ، سوگ و شکوه. اما شاهنامه بسیار فراتر از مجموعه‌ای از داستان‌ها بود؛ تلاشی برای حفظ میراث یک ملت و ایستادگی در برابر فراموشی.' },
          ...
          { t: 'numstat', items: [
            { n: '30+', label: 'Years of his life given to the work', labelFa: 'سال‌هایی از عمرش که پای این کار گذاشت' },
            { n: '~60,000', label: 'Verses in the Shahnameh', labelFa: 'بیت‌های شاهنامه' },
            { n: '1,000+', label: 'Years it has been loved, unbroken', labelFa: 'سال‌هایی که بی‌وقفه محبوب بوده است' },
            { n: 'One', label: 'Book that saved a language', labelFa: 'کتابی که زبانی را نجات داد' },
          ] },
        ] },
        { blocks: [
          { t: 'p', x: 'There is a line, long attributed to him, that captures all he did and all he hoped. Having labored so long, he looked upon his finished work and understood what he had built, a monument no conqueror could throw down.', fa: 'بیتی هست که از دیرباز به او نسبت داده‌اند و همهٔ آنچه کرد و همهٔ آنچه امید داشت را در خود خلاصه می‌کند. پس از آن‌همه سال رنج و تلاش، به اثر به‌پایان‌رسیدهٔ خود نگریست و فهمید چه بنای ماندگاری ساخته است؛ یادگاری که هیچ فاتحی نمی‌توانست آن را فرو بریزد.' },
          { t: 'quotebig', x: 'I have suffered greatly these thirty years, but I have revived the Persians with this Persian tongue.', fa: 'بسی رنج بردم در این سال سی\nعجم زنده کردم بدین پارسی', by: 'ATTRIBUTED TO FERDOWSI', byFa: 'منسوب به فردوسی' },
        ] },
      ],
    },
    {
      ...
      pages: [
        { blocks: [
          ...
          { t: 'markline', x: 'The two centuries of silence ended, and Iran has never stopped speaking since.', fa: 'دو قرن سکوت به پایان رسید و ایران از آن پس هرگز از سخن گفتن بازنایستاد.' },
        ] },
        { blocks: [
          { t: 'div' },
          ...
          { t: 'pull', x: 'A people held their soul through the long silence, and a poet gave them back their voice.', fa: 'مردمی در طول آن سکوت طولانی جان خود را حفظ کردند و شاعری صدایشان را به آنان بازگرداند.' },
        ] },
      ],
    },
  ],
  ...
  chapters: [
    {
      ...
      pages: [
        { blocks: [
          ...
          { t: 'p', x: 'For a time, Greek kings sat where the Persian kings of kings had ruled. Greek became the language of the court, Greek cities rose across the plateau, and the proud heartland of Cyrus and Darius answered to masters from a distant western land.', fa: 'مدتی، شاهان یونانی بر جایی فرمان راندند که پیش‌تر شاهنشاهان ایران بر آن حکومت می‌کردند. یونانی زبان دربار شد، شهرهای یونانی در سراسر فلات سر برآوردند و قلب سربلند سرزمین کوروش و داریوش به فرمانروایانی از سرزمینی دور در غرب گردن نهاد.' },
        ...
        { blocks: [
          ...
          { t: 'p', x: 'But Iran would not stay in foreign hands. From the northeast, from the wide grasslands beyond the Caspian, came a people of hardy nomadic horsemen: the Parni, led by a chief named Arsaces. Around the middle of the third century BCE, they swept into the region of Parthia and threw off Greek rule.', fa: 'اما ایران قرار نبود برای همیشه در دست بیگانگان بماند. از شمال‌شرق، از علفزارهای پهناور آن سوی خزر، مردمی از سوارکاران کوچ‌نشین و سخت‌جان آمدند: پَرنی‌ها، به رهبری سرداری به نام ارشک. حدود میانهٔ سدهٔ سوم پیش از میلاد، به سرزمین پارت تاختند و یوغ فرمانروایی یونانیان را برکندند.' },
          { t: 'p', x: 'From that homeland the dynasty took its name, and Arsaces gave his to the line of kings who followed, the Arsacids. From these beginnings, a small rebellion on the edge of a Greek empire, would grow one of the great powers of the ancient world.', fa: 'سلسله نام خود را از همان سرزمین گرفت و ارشک نیز نامش را به تبار شاهانی داد که پس از او آمدند: اشکانیان. از همین آغاز کوچک، یعنی شورشی در حاشیهٔ یک امپراتوری یونانی، یکی از قدرت‌های بزرگ جهان باستان سر برآورد.' },
          { t: 'imgwide', key: 'parthian-arsaces', capFa: 'اشک یکم، سرکردهٔ پرنی‌ها، سلسله‌ای را بنیان نهاد که یونانیان را از ایران بیرون راند.', cap: 'Arsaces I, chief of the Parni, founded the dynasty that would drive the Greeks from Iran and rule for nearly five centuries.', capFa: 'ارشک یکم، سردار پَرنی‌ها، سلسله‌ای را بنیان گذاشت که یونانیان را از ایران بیرون راند و نزدیک به پنج قرن بر کشور فرمان راند.' },
        ] },
      ],
    },
    {
      key: 'pt2',
      title: 'The Reconquest of a Homeland', titleFa: 'بازپس‌گیری سرزمین مادری',
      subtitle: '2nd century BCE',
      pages: [
        { blocks: [
          { t: 'p', x: 'What began as a frontier revolt became, over the generations, the reconquest of an entire empire. The Parthian kings pushed steadily westward and southward, city by city and province by province, driving back the weakening Greek Seleucids and restoring Iranian rule over the ancient Persian lands.', fa: 'آنچه با شورشی در مرزها آغاز شده بود، در گذر نسل‌ها به بازپس‌گیری یک امپراتوری تمام‌عیار تبدیل شد. شاهان اشکانی پیوسته به سوی غرب و جنوب پیش رفتند، شهر به شهر و سرزمین به سرزمین، سلوکیانِ رو به ضعف را عقب راندند و فرمانروایی ایرانی را بر سرزمین‌های کهن پارس دوباره برقرار کردند.' },
          { t: 'p', x: 'The greatest of these early kings was Mithridates the First, who in the second century BCE transformed the Parthian realm from a kingdom into an empire, taking the rich lands of Mesopotamia and the title, once more, of a great Iranian king.', fa: 'بزرگ‌ترینِ این شاهان نخستین، مهرداد یکم بود که در سدهٔ دوم پیش از میلاد قلمرو اشکانی را از پادشاهی به امپراتوری تبدیل کرد؛ سرزمین‌های ثروتمند میان‌رودان را به تصرف درآورد و بار دیگر عنوان شاه بزرگ ایران را از آنِ خود کرد.' },
        ] },
        { blocks: [
          { t: 'ribbon', items: [
            { year: '247 BCE', yearFa: '۲۴۷ پ.م', label: 'Arsaces founds the Parthian state', labelFa: 'اشک دولت اشکانی را بنیان می‌گذارد' },
            { year: '171 BCE', yearFa: '۱۷۱ پ.م', label: 'Mithridates I begins the great expansion', labelFa: 'مهرداد یکم گسترش بزرگ را آغاز می‌کند' },
            { year: '141 BCE', yearFa: '۱۴۱ پ.م', label: 'The Parthians take Mesopotamia and Babylon', labelFa: 'اشکانیان میان‌رودان و بابل را تصرف می‌کنند' },
            { year: '1st c. BCE', yearFa: 'سدهٔ یکم پ.م', label: 'Parthia stands as a great world power', labelFa: 'اشکانیان در جایگاه یک قدرت بزرگ جهانی قرار می‌گیرند' },
          ] },
          ...
          { t: 'markline', x: 'From horsemen of the steppe rose the empire that made Iran Iranian again.', fa: 'از میان سوارکاران دشت، امپراتوری‌ای برخاست که ایران را دوباره ایرانی کرد.' },
        ] },
      ],
    },
    {
      ...
      pages: [
        { blocks: [
          ...
          { t: 'p', x: 'Rome, used to conquering all before it, found in Parthia an equal it could not overcome. Again and again the legions marched east, and again and again the Parthians turned them back. The Euphrates became the wall against which Roman ambition broke.', fa: 'روم که به فتح هر سرزمینی پیش رویش عادت داشت، در اشکانیان هماوردی یافت که نتوانست بر آن غلبه کند. بارها لژیون‌های روم به سوی شرق لشکر کشیدند و بارها اشکانیان آنها را عقب راندند. فرات به دیواری تبدیل شد که جاه‌طلبی روم بر آن درهم شکست.' },
        ] },
        { blocks: [
          { t: 'h', x: 'The disaster at Carrhae', fa: 'فاجعهٔ حَرّان' },
          ...
          { t: 'numstat', items: [
            { n: '53 BCE', nFa: '۵۳ پ.م', label: 'The battle of Carrhae', labelFa: 'نبرد حَرّان' },
            { n: 'Crassus', nFa: 'کراسوس', label: 'The Roman commander slain', labelFa: 'سردار رومی که کشته شد' },
            { n: '~300', label: 'Years Parthia held Rome at bay', labelFa: 'سال‌هایی که اشکانیان روم را پشت مرزهای خود نگه داشتند' },
            { n: 'Euphrates', nFa: 'فرات', label: 'The frontier Rome could not cross', labelFa: 'مرزی که روم نتوانست از آن عبور کند' },
          ] },
        ] },
        { blocks: [
          ...
          { t: 'markline', x: 'They mastered the art of striking hardest at the moment they seemed to flee.', fa: 'آنان هنر آن را آموخته بودند که درست در لحظه‌ای که گویی در حال گریزند، سخت‌ترین ضربه را وارد کنند.' },
        ] },
      ],
    },
    {
      ...
      pages: [
        { blocks: [
          { t: 'p', x: 'The Parthian Empire sat astride the greatest trade route in the world: the Silk Road, the long ribbon of commerce that linked the empires of Rome and China. Through Parthian lands passed the silk of the east and the gold of the west, and the empire grew rich as the great middleman of the world.', fa: 'امپراتوری اشکانی بر سر بزرگ‌ترین راه بازرگانی جهان قرار داشت: جادهٔ ابریشم، نوار بلند تجارت که امپراتوری‌های روم و چین را به هم پیوند می‌داد. ابریشم شرق و طلای غرب از سرزمین‌های اشکانی می‌گذشت و امپراتوری از این نقش واسطهٔ بزرگ میان شرق و غرب ثروتمند شد.' },
        ...
        { blocks: [
          { t: 'h', x: 'A looser kind of empire', fa: 'امپراتوری‌ای با انسجامی سست‌تر' },
          ...
          { t: 'p', x: 'For all its strength against Rome, the empire was often divided within, and its long centuries were marked by civil wars and contested successions that slowly wore at its foundations.', fa: 'با همهٔ قدرتی که در برابر روم داشت، امپراتوری اغلب در درون خود دچار تفرقه بود و قرن‌های طولانی فرمانروایی‌اش با جنگ‌های داخلی و کشمکش بر سر جانشینی همراه شد؛ کشمکش‌هایی که به‌آرامی پایه‌های آن را فرسوده کردند.' },
        ] },
      ],
    },
    {
      ...
      pages: [
        { blocks: [
          { t: 'p', x: 'After nearly five hundred years, the Parthian Empire grew weary. Weakened by endless wars with Rome and by its own internal divisions, the once mighty realm was ripe for change. And change came, as it so often did in Iran, from the ancient heartland of Persia in the south.', fa: 'پس از نزدیک به پانصد سال، امپراتوری اشکانی فرسوده شد. جنگ‌های بی‌پایان با روم و تفرقه‌های درونی آن را ناتوان کرده بود و این قلمروِ روزگاری نیرومند آمادهٔ دگرگونی بود. و دگرگونی، چنان‌که بارها در تاریخ ایران رخ داده است، از قلب کهن سرزمین پارس در جنوب آمد.' },
          { t: 'p', x: 'There, a prince named Ardashir rose in rebellion. In 224 CE he defeated the last Parthian king in battle, and upon the ruins of the Arsacid realm he raised a new empire, the Sasanian, which would carry Persia to fresh heights of glory.', fa: 'آنجا شاهزاده‌ای به نام اردشیر سر به شورش برداشت. در سال ۲۲۴ میلادی، واپسین شاه اشکانی را در نبرد شکست داد و بر ویرانه‌های قلمرو اشکانی، امپراتوری تازه‌ای برپا کرد: شاهنشاهی ساسانی، که ایران را به اوج‌های تازه‌ای از شکوه می‌رساند.' },
          { t: 'markline', x: 'One Iranian empire gave way to another, and the flame passed on.', fa: 'یک امپراتوری ایرانی جای خود را به دیگری داد و شعله به دست دیگری سپرده شد.' },
        ] },
        { blocks: [
          { t: 'div' },
          ...
          { t: 'p', x: 'They kept the flame of Iran burning through the long centuries between two golden ages, and they handed it on, undimmed, to those who followed. Without the horsemen of Parthia, the story of Iran might have ended long ago.', fa: 'آنان شعلهٔ ایران را در قرن‌های طولانی میان دو عصر طلایی فروزان نگه داشتند و آن را بی‌آنکه از فروغش کاسته شود، به آیندگان سپردند. اگر سوارکاران پارت نبودند، شاید داستان ایران قرن‌ها پیش به پایان رسیده بود.' },
          { t: 'pull', x: 'They kept the flame of Iran alive, and passed it on undimmed.', fa: 'آنان شعلهٔ ایران را زنده نگه داشتند و بی‌آنکه از فروغش کاسته شود، آن را به آیندگان سپردند.' },
        ] },
      ],
    },
  ],
  ...
  chapters: [
    {
      ...
      pages: [
        { blocks: [
          ...
          { t: 'splitimg', key: 'afsharid-nader-young', title: 'Nader of the Afshar', titleFa: 'نادرِ افشار', x: 'Born in poverty and once a captive, Nader rose by his genius for war to command armies and, in time, an empire.', fa: 'نادر در تنگدستی به دنیا آمد و روزگاری نیز به اسارت رفت؛ اما نبوغش در جنگ او را از فرودستی بالا کشید تا جایی که فرمانده سپاه‌ها و سرانجام فرمانروای یک امپراتوری شد.' },
        ] },
        { blocks: [
          ...
          { t: 'markline', x: 'A shepherd boy had become the sword that saved a nation.', fa: 'پسر چوپان به شمشیری تبدیل شده بود که ایران را نجات داد.' },
        ] },
      ],
    },
    {
      ...
      pages: [
        ...
        { blocks: [
          { t: 'h', x: 'The Napoleon of Persia', fa: 'ناپلئون ایران' },
          ...
          { t: 'markline', x: 'He remade the army of Iran into the terror of the East.', fa: 'او ارتش ایران را از نو ساخت و آن را به هراسِ شرق تبدیل کرد.' },
        ] },
      ],
    },
    {
      ...
      pages: [
        { blocks: [
          { t: 'p', x: 'Nader\'s most famous campaign was his boldest. In 1738 he led his army eastward, through Afghanistan and over the mountains, and descended upon the vast and fabulously wealthy Mughal Empire of India, the richest realm on earth.', fa: 'نامدارترین لشکرکشی نادر، جسورانه‌ترین لشکرکشی او نیز بود. در سال ۱۷۳۸، سپاهش را به سوی شرق برد، از افغانستان و فراز کوه‌ها گذشت و بر امپراتوری پهناور و افسانه‌وار ثروتمند گورکانیان هند فرود آمد؛ ثروتمندترین قلمرو روی زمین.' },
          { t: 'p', x: 'At the battle of Karnal, his smaller, hardened army shattered the enormous but unwieldy Mughal host in a single day. The road to Delhi, the jewel of the East, lay open before him.', fa: 'در نبرد کرنال، سپاه کوچک‌تر اما آبدیدهٔ او لشکر عظیم و سنگین گورکانیان را در یک روز درهم شکست. راه دهلی، نگین شرق، پیش رویش گشوده شد.' },
        ] },
        { blocks: [
          { t: 'h', x: 'The treasure of the world', fa: 'گنجینهٔ جهان' },
          { t: 'p', x: 'Nader entered Delhi in triumph, and the wealth he carried away from it was almost beyond counting, the accumulated treasure of the Mughal emperors gathered over two centuries. The plunder was so immense that, upon his return, he is said to have exempted the people of Iran from taxes for years.', fa: 'نادر پیروزمندانه وارد دهلی شد و ثروتی که از آنجا با خود برد، تقریباً قابل شمارش نبود؛ گنجینه‌ای انباشته از ثروت پادشاهان گورکانی در طول دو قرن. غنیمت چنان عظیم بود که گفته‌اند پس از بازگشت، مردم ایران را برای سال‌ها از پرداخت مالیات معاف کرد.' },
          { t: 'numstat', items: [
            { n: '1739', label: 'Nader captures Delhi', labelFa: 'نادر دهلی را تصرف می‌کند' },
            { n: 'Karnal', nFa: 'کرنال', label: 'The Mughal army destroyed in a day', labelFa: 'سپاه گورکانیان در یک روز درهم می‌شکند' },
            { n: '3 years', nFa: '۳ سال', label: 'Taxes he waived in Iran from the plunder', labelFa: 'مالیات‌هایی که نادر به برکت غنیمت‌ها در ایران بخشید' },
            { n: 'Untold', nFa: 'بی‌شمار', label: 'Riches carried home from India', labelFa: 'ثروتی که از هند به ایران آورد' },
          ] },
        ] },
        { blocks: [
          { t: 'h', x: 'The Peacock Throne and a mountain of light', fa: 'تخت طاووس و کوه نور' },
          { t: 'p', x: 'Among the treasures he took were the most legendary jewels in the world. He carried away the fabled Peacock Throne of the Mughal emperors, glittering with gems, which became the very symbol of the Persian monarchy for centuries after.', fa: 'در میان گنجینه‌هایی که با خود برد، افسانه‌ای‌ترین جواهرات جهان نیز بود. او تخت افسانه‌ای طاووسِ پادشاهان گورکانی را با خود آورد؛ تختی پوشیده از جواهرات درخشان که در قرن‌های پس از آن به نماد پادشاهی ایران تبدیل شد.' },
          { t: 'p', x: 'And among the jewels were two of the most famous diamonds ever known: the Darya-ye Noor, the Sea of Light, which remains in Iran to this day, and the Koh-i-Noor, the Mountain of Light, whose later journey would carry it, in time, to the crown jewels of England. The treasures of Nader\'s Indian campaign became legends in their own right.', fa: 'در میان آن جواهرات، دو الماس از مشهورترین الماس‌های تاریخ نیز بودند: دریای نور، که تا امروز در ایران باقی مانده است، و کوه نور، که در ادامهٔ سفر تاریخی خود سرانجام به جواهرات سلطنتی انگلستان راه یافت. گنجینه‌های لشکرکشی نادر به هند، خود به افسانه‌هایی ماندگار تبدیل شدند.' },
          { t: 'splitimg', key: 'afsharid-peacock-throne', title: 'The Peacock Throne', titleFa: 'تخت طاووس', x: 'From Delhi, Nader carried home the jewelled Peacock Throne and the legendary diamonds of the Mughals, treasures still spoken of today.', fa: 'نادر از دهلی تخت طاووسِ نگین‌نشان و الماس‌های افسانه‌ای گورکانیان را با خود به ایران آورد؛ گنجینه‌هایی که هنوز هم از آنها سخن گفته می‌شود.' },
        ] },
      ],
    },
    {
      ...
      pages: [
        { blocks: [
          { t: 'p', x: 'Nader was a man of dazzling gifts, and his mind ranged far beyond the battlefield. He was a military innovator who understood artillery and the modern arts of war better than almost anyone in the East, and he even sought to build a navy for Iran on the Persian Gulf, a rare and forward-looking ambition.', fa: 'نادر مردی با توانایی‌های خیره‌کننده بود و ذهنش بسیار فراتر از میدان جنگ می‌رفت. او نوآوری در عرصهٔ نظامی بود که توپخانه و فنون نوین جنگ را بهتر از تقریباً هر کس دیگری در شرق می‌شناخت و حتی کوشید برای ایران در خلیج فارس نیروی دریایی بسازد؛ آرزویی کم‌سابقه و آینده‌نگرانه.' },
          { t: 'p', x: 'He was also, in matters of faith, a pragmatist who tried to heal the ancient rift between the Sunni and Shia branches of Islam, hoping to unite them and end centuries of division, a strikingly bold idea for his age.', fa: 'در مسائل دینی نیز مردی عمل‌گرا بود. کوشید شکاف کهن میان دو شاخهٔ سنی و شیعهٔ اسلام را التیام بخشد، به امید آنکه آنها را به هم نزدیک کند و به قرن‌ها جدایی پایان دهد؛ اندیشه‌ای به‌طرزی چشمگیر جسورانه برای روزگار خودش.' },
          { t: 'duo', left: { title: 'The genius', titleFa: 'نبوغ', x: 'A brilliant general and innovator who saved Iran, conquered India, and dreamed of a navy and religious peace.', fa: 'سرداری درخشان و نوآور که ایران را نجات داد، هند را فتح کرد و رؤیای ساختن نیروی دریایی و برقراری صلح مذهبی را در سر داشت.' }, right: { title: 'The shadow', titleFa: 'سایه', x: 'A ruler who grew ever more cruel, suspicious, and tyrannical as the years and the wars wore on.' } },
        ] },
        { blocks: [
          { t: 'h', x: 'The darkening of a great mind', fa: 'تیره شدن ذهنی بزرگ' },
          ...
          { t: 'markline', x: 'The sword that saved Iran turned, in the end, against its own people.', fa: 'شمشیری که ایران را نجات داده بود، سرانجام علیه مردم خودش به کار افتاد.' },
        ] },
      ],
    },
    {
      ...
      pages: [
        { blocks: [
          ...
          { t: 'p', x: 'In the night, a band of his own commanders crept into his tent and killed him as he slept. The greatest warrior of the age, who had conquered from the Caucasus to Delhi and whom no enemy could defeat in the field, fell at last to the daggers of his own men.', fa: 'شبانه، گروهی از فرماندهان خودش به خیمه‌اش رفتند و او را در خواب کشتند. بزرگ‌ترین جنگاور آن روزگار، که از قفقاز تا دهلی را فتح کرده بود و هیچ دشمنی در میدان نبرد نتوانسته بود شکستش دهد، سرانجام به دست مردان خودش از پا درآمد.' },
          { t: 'markline', x: 'No enemy could defeat him. Only his own could bring him down.', fa: 'هیچ دشمنی نتوانست شکستش دهد؛ تنها مردان خودش توانستند از پای درش بیاورند.' },
        ] },
        { blocks: [
          ...
          { t: 'p', x: 'From the chaos that followed his death, in time, would rise the gentle Karim Khan of the Zand, who gave Iran the peace that Nader, for all his conquests, never could.', fa: 'از دل آشوبی که پس از مرگش به وجود آمد، سرانجام کریم‌خان زندِ آرام و مهربان سر برآورد؛ مردی که آرامشی به ایران بخشید که نادر، با همهٔ فتوحاتش، هرگز نتوانست به آن دست یابد.' },
        ] },
        { blocks: [
          { t: 'div' },
          { t: 'p', x: 'This has been a glimpse of Nader Shah and the Afsharids, one of the most extraordinary and complex stories in all of Iranian history. Nader was a shepherd boy who became a conqueror to rival the greatest of the ancient world, a military genius who saved his nation from ruin and carried its banners to the gates of the East.', fa: 'این نگاهی کوتاه بود به نادرشاه و افشاریان؛ یکی از شگفت‌انگیزترین و پیچیده‌ترین داستان‌ها در سراسر تاریخ ایران. نادر پسر چوپانی بود که به فاتحی در حد بزرگ‌ترین فاتحان جهان باستان تبدیل شد؛ نابغه‌ای نظامی که ملتش را از ویرانی نجات داد و پرچم‌هایش را تا دروازه‌های شرق پیش برد.' },
          ...
          { t: 'pull', x: 'A shepherd who conquered an empire, and a genius undone by his own shadow.', fa: 'چوپانی که امپراتوری‌ای را فتح کرد و نابغه‌ای که سرانجام سایهٔ خودش او را از پا درآورد.' },
        ] },
      ],
    },
  ],
  ...
  chapters: [
    {
      ...
      pages: [
        { blocks: [
          ...
          { t: 'p', x: 'In 1040 they shattered the armies of the reigning power at the battle of Dandanaqan, and the road into Iran lay open. Under their leader Tughril, they took city after city, until at last Tughril entered Baghdad itself and was named Sultan, protector of the Islamic world.', fa: 'در سال ۱۰۴۰، در نبرد دندانقان، سپاه قدرت حاکم را درهم شکستند و راه ورود به ایران برایشان گشوده شد. به رهبری طغرل، شهر پس از شهر را گرفتند تا سرانجام طغرل خود وارد بغداد شد و او را سلطان، یعنی نگاهبان جهان اسلام، خواندند.' },
          { t: 'splitimg', key: 'seljuk-tughril', title: 'Tughril Beg', titleFa: 'طغرل بیک', x: 'Tughril led the Seljuks from the steppe into Iran and beyond, founding an empire that stretched from Central Asia to the Mediterranean.', fa: 'طغرل سلجوقیان را از دشت‌های آسیای میانه به ایران و فراتر از آن رهبری کرد و امپراتوری‌ای بنیان گذاشت که از آسیای میانه تا مدیترانه گسترده بود.' },
        ] },
        { blocks: [
          ...
          { t: 'markline', x: 'They conquered Iran with the sword, and Iran conquered them with its culture.', fa: 'آنان ایران را با شمشیر فتح کردند و ایران آنان را با فرهنگ خود فتح کرد.' },
          { t: 'p', x: 'The conquerors became patrons of Persian civilization, and under their rule, though the sultans were Turks, the soul of the state was Persian. It was a marriage of the vigour of the steppe and the refinement of Iran, and it produced a golden age.', fa: 'فاتحان به حامیان تمدن ایرانی بدل شدند و در روزگار آنان، هرچند سلطان‌ها ترک بودند، روح و فرهنگ دولت ایرانی بود. این پیوندی بود میان نیروی دشت و ظرافت ایران و از دل آن عصری طلایی زاده شد.' },
        ] },
      ],
    },
    {
      ...
      pages: [
        { blocks: [
          { t: 'p', x: 'The true architect of the Seljuk golden age was not a sultan but a Persian statesman, one of the greatest administrators in the history of Iran: Nizam al-Mulk, the great vizier who guided the empire at its height for thirty years.', fa: 'معمار راستین عصر طلایی سلجوقیان نه یک سلطان، بلکه سیاستمداری ایرانی بود؛ یکی از بزرگ‌ترین دولتمردان تاریخ ایران: خواجه نظام‌الملک، وزیر بزرگی که سی سال در دوران اوج امپراتوری، آن را اداره کرد.' },
          { t: 'splitimg', key: 'seljuk-nizam', title: 'Nizam al-Mulk', titleFa: 'خواجه نظام‌الملک', x: 'The brilliant Persian vizier who ran the Seljuk Empire for three decades and wrote a famous book on the art of governing.', fa: 'وزیر درخشان ایرانی که سه دهه امپراتوری سلجوقی را اداره کرد و کتابی نامدار دربارهٔ هنر کشورداری نوشت.' },
        ...
        { blocks: [
          ...
          { t: 'p', x: 'This was an age of extraordinary Persian genius. At the Seljuk court worked Omar Khayyam, one of the most remarkable minds of any age: a brilliant mathematician who advanced algebra, and an astronomer who reformed the calendar into one more accurate than any then known in the world.', fa: 'این روزگار، عصر نبوغ چشمگیر ایرانی بود. در دربار سلجوقی عمر خیام فعالیت می‌کرد؛ یکی از شگفت‌انگیزترین ذهن‌های هر عصر، ریاضی‌دانی درخشان که علم جبر را پیش برد و ستاره‌شناسی که تقویم را چنان اصلاح کرد که از هر تقویم شناخته‌شدهٔ آن روز جهان دقیق‌تر بود.' },
          { t: 'p', x: 'And Khayyam was also a poet, whose quatrains, the Rubaiyat, meditating on life, time, and the fleeting beauty of the world, would one day be loved across the entire earth. That one man could be at once a great scientist and a great poet is a wonder that captures the spirit of this golden age.', fa: 'خیام شاعر هم بود؛ رباعیاتش، که در آنها از زندگی، زمان و زیبایی گذرای جهان تأمل می‌کرد، روزی در سراسر جهان محبوب شد. اینکه یک نفر می‌توانست هم‌زمان دانشمندی بزرگ و شاعری بزرگ باشد، شگفتی‌ای است که به‌خوبی روح این عصر طلایی را نشان می‌دهد.' },
          { t: 'numstat', items: [
            { n: 'Algebra', nFa: 'جبر', label: 'Khayyam advanced its foundations', labelFa: 'خیام بنیادهای آن را پیش برد' },
            { n: 'Calendar', nFa: 'تقویم', label: 'A reform of astonishing accuracy', labelFa: 'اصلاحی با دقتی شگفت‌انگیز' },
            { n: 'Rubaiyat', nFa: 'رباعیات', label: 'Poetry beloved around the world', labelFa: 'شعری محبوب در سراسر جهان' },
            { n: 'One mind', nFa: 'یک ذهن', label: 'Scientist and poet at once', labelFa: 'هم دانشمند و هم شاعر' },
          ] },
        ] },
        { blocks: [
          ...
          { t: 'markline', x: 'A golden age of Persian art and science bloomed under the Turkish sultans.', fa: 'در زیر فرمان سلطان‌های ترک، عصری طلایی از هنر و دانش ایرانی شکوفا شد.' },
        ] },
      ],
    },
    {
      ...
      pages: [
        { blocks: [
          ...
          { t: 'p', x: 'These successor states carried on the Seljuk legacy for another century, and in places like Anatolia the Seljuk name endured even longer, laying foundations for the Turkish presence there that continues to this day. But the unity of the great empire was gone.', fa: 'این دولت‌های جانشین یک قرن دیگر میراث سلجوقی را ادامه دادند و در جاهایی مانند آناتولی، نام سلجوقیان حتی مدت بیشتری باقی ماند و پایه‌های حضور ترک‌ها را در آنجا گذاشت؛ حضوری که تا امروز ادامه دارد. اما یکپارچگی آن امپراتوری بزرگ دیگر از میان رفته بود.' },
        ] },
        { blocks: [
          { t: 'div' },
          { t: 'p', x: 'This has been a glimpse of the Seljuks, Turkic conquerors who became the great patrons of Persian civilization. Under their rule, Iran\'s culture, art, architecture, and science flourished brilliantly, and its influence spread across a vast empire from Central Asia to the Mediterranean.', fa: 'این نگاهی کوتاه بود به سلجوقیان؛ فاتحانی ترک که به حامیان بزرگ تمدن ایرانی بدل شدند. در روزگار آنان، فرهنگ، هنر، معماری و دانش ایران با شکوهی چشمگیر شکوفا شد و نفوذش در امپراتوری‌ای پهناور از آسیای میانه تا مدیترانه گسترش یافت.' },
  ...
  chapters: [
    {
      ...
      pages: [
        { blocks: [
          ...
          { t: 'markline', x: 'The Mongol storm was one of the greatest catastrophes Iran ever endured.', fa: 'توفان مغول یکی از بزرگ‌ترین فاجعه‌هایی بود که ایران در تاریخ خود از سر گذراند.' },
        ] },
        { blocks: [
    ...
    },
    {
      ...
      pages: [
        { blocks: [
          ...
          { t: 'markline', x: 'The civilization they had nearly destroyed rose up and remade them in its image.', fa: 'تمدنی که نزدیک بود آن را نابود کنند، دوباره سر برآورد و آنان را به شکل خود از نو ساخت.' },
        ...
        { blocks: [
          { t: 'h', x: 'A flowering from the ashes', fa: 'شکوفایی از دل خاکستر' },
          ...
          { t: 'p', x: 'Persian painting, enriched now by contact with the art of China, entered one of its most beautiful periods. Architecture, history, and science flourished under Mongol patronage. From the ashes of the greatest catastrophe, Iran had conjured a new flowering of its genius.', fa: 'نگارگری ایرانی که اکنون از پیوند با هنر چین غنا یافته بود، وارد یکی از زیباترین دوره‌های خود شد. معماری، تاریخ‌نگاری و دانش زیر حمایت مغولان شکوفا شدند. ایران از دل خاکستر بزرگ‌ترین فاجعه‌اش، شکوفایی تازه‌ای از نبوغ خود پدید آورد.' },
          { t: 'splitimg', key: 'ilkhanate-rashid', title: 'Rashid al-Din', titleFa: 'رشیدالدین فضل‌الله', x: 'The Persian vizier and scholar who wrote a history of the world, and helped transform the Mongol conquerors into patrons of Persian civilization.', fa: 'وزیر و دانشمند ایرانی که تاریخ جهان را نوشت و به تبدیل فاتحان مغول به حامیان تمدن ایرانی کمک کرد.' },
        ] },
        { blocks: [
          { t: 'div' },
          { t: 'p', x: 'This has been a glimpse of the Ilkhanate, the age of the Mongols in Iran, a story of catastrophe and, against all odds, of renewal. The Mongol invasion was among the most destructive events the nation ever suffered, and its wounds were deep and lasting.', fa: 'این نگاهی کوتاه بود به ایلخانان، روزگار مغول در ایران؛ روایتی از فاجعه و، برخلاف همهٔ انتظارها، از نوزایی. هجوم مغول یکی از ویرانگرترین رویدادهایی بود که این ملت در تاریخ خود از سر گذراند و زخم‌هایش عمیق و ماندگار بود.' },
...
const modernIran: Topic = {
  ...
  essenceFa: 'ایران از انقلاب تاکنون: جنگ، فرمانروایانی که پس از آن آمدند، و سقوطی طولانی و پیوسته در ارزش پول ملی. آنچه بر کشور گذشت، به ترتیب، و تا حد ممکن ساده و روشن.',
  cover: 'modern-cover',
  ...
  chapters: [
    {
      ...
      pages: [
        { blocks: [
          ...
          { t: 'splitimg', key: 'timurid-timur', title: 'Timur (Tamerlane)', titleFa: 'تیمور لنگ', x: 'A conqueror never defeated in battle, and one of the most feared men in history, Timur built a vast empire across the Persian world.', fa: 'تیمور، فاتحی که هرگز در میدان نبرد شکست نخورد و یکی از هراس‌انگیزترین مردان تاریخ بود، امپراتوری‌ای پهناور در سراسر جهان ایرانی برپا کرد.' },
        ] },
        { blocks: [
          { t: 'h', x: 'The jewel of Samarkand', fa: 'نگین سمرقند' },
          { t: 'p', x: 'Yet this terrible conqueror was also a great patron of beauty. He gathered to his capital of Samarkand the finest artists, architects, and craftsmen from across all the lands he conquered, and adorned the city with monuments of breathtaking splendour, blue-domed and shimmering, among the wonders of the world.', fa: 'با این همه، این فاتح هولناک حامی بزرگ هنر و زیبایی نیز بود. او بهترین هنرمندان، معماران و صنعتگران را از سراسر سرزمین‌هایی که فتح کرده بود به پایتختش، سمرقند، آورد و شهر را با بناهایی خیره‌کننده آراست؛ بناهایی با گنبدهای آبی و درخشان که در شمار شگفتی‌های جهان بودند.' },
          { t: 'markline', x: 'The hand that raised towers of skulls also raised the shimmering domes of Samarkand.', fa: 'همان دستی که کله‌مناره‌ها را برپا می‌کرد، گنبدهای درخشان سمرقند را نیز برپا کرد.' },
          { t: 'p', x: 'It is one of history\'s great contradictions, that a man of such cruelty should also be the founder of one of the most beautiful cultural ages the East ever knew. But so it was, and the splendour he began would blossom fully under his descendants.', fa: 'این یکی از تناقض‌های بزرگ تاریخ است که مردی با چنین بی‌رحمی، بنیان‌گذار یکی از زیباترین دوره‌های فرهنگی‌ای باشد که شرق به خود دیده است. اما چنین شد و شکوهی که او آغاز کرد، در روزگار بازماندگانش به‌تمامی شکوفا شد.' },
        ] },
      ],
    },
    {
      key: 'tm2',
      title: 'The Timurid Renaissance', titleFa: 'رنسانس تیموری',
      subtitle: '1405 - 1507',
      pages: [
        { blocks: [
          { t: 'p', x: 'After Timur\'s death, his descendants gave up the endless conquering and turned instead to the cultivation of beauty, and under them the Persian world entered one of the most brilliant cultural renaissances in its entire history, a flowering compared by many to the Italian Renaissance of the same age.', fa: 'پس از مرگ تیمور، بازماندگانش فتوحات بی‌پایان را رها کردند و به پرورش هنر و زیبایی روی آوردند. در روزگار آنان، جهان ایرانی وارد یکی از درخشان‌ترین دوره‌های شکوفایی فرهنگی در سراسر تاریخ خود شد؛ شکوفایی‌ای که بسیاری آن را با رنسانس ایتالیا در همان دوران مقایسه کرده‌اند.' },
          { t: 'p', x: 'His son Shahrukh and grandson Ulugh Beg, and later the court at Herat, made their cities into dazzling centers of art, learning, and refinement, where the Persian genius reached new summits in almost every field.', fa: 'پسرش شاهرخ و نوه‌اش الغ‌بیگ، و پس از آنان دربار هرات، شهرهای خود را به کانون‌های درخشان هنر، دانش و ظرافت تبدیل کردند؛ جایی که نبوغ ایرانی تقریباً در هر زمینه‌ای به قله‌های تازه‌ای رسید.' },
        ] },
        { blocks: [
          { t: 'h', x: 'A king who mapped the stars', fa: 'شاهی که ستارگان را نقشه‌برداری کرد' },
          ...
          { t: 'numstat', items: [
            ...
            { n: 'Samarkand', nFa: 'سمرقند', label: 'An observatory that mapped the stars', labelFa: 'رصدخانه‌ای که ستارگان را نقشه‌برداری کرد' },
            { n: 'Painting', nFa: 'نگارگری', label: 'The golden age of the Persian miniature', labelFa: 'عصر طلایی نگارگری ایرانی' },
            { n: 'Renaissance', nFa: 'رستاخیز', label: 'A flowering to rival Italy\'s', labelFa: 'شکوفایی‌ای هم‌سنگ رنسانس ایتالیا' },
          ] },
        ] },
        { blocks: [
          ...
          { t: 'splitimg', key: 'timurid-miniature', title: 'The Persian miniature', titleFa: 'نگارگری ایرانی', x: 'Under the Timurids, the art of the miniature reached a delicacy and beauty that has never been surpassed.', fa: 'در روزگار تیموریان، هنر نگارگری به چنان ظرافت و زیبایی‌ای رسید که از آن پس هرگز نظیری برایش پدید نیامد.' },

      ...
      pages: [
        ...
        { blocks: [
          ...
          { t: 'boxes', items: [
            ...
            { title: 'The clergy', titleFa: 'روحانیت', x: 'Objected to female suffrage, and to land reform reaching religious endowments. Some read the wider programme as reducing their place in Iranian life.', fa: 'با حق رأی زنان و نیز با گسترش اصلاحات ارضی به موقوفات مخالفت می‌کرد. برخی، مجموعهٔ گسترده‌تر این اصلاحات را تلاشی برای کم‌رنگ کردن جایگاه آنان در زندگی ایران می‌دانستند.' },
            { title: 'The secular left', titleFa: 'چپ سکولار', x: 'Argued that change handed down from a throne, without a corresponding widening of political life, was incomplete.', fa: 'استدلال می‌کرد که تغییراتی که از بالا و از جانب سلطنت تحمیل می‌شوند، بدون گشایش هم‌زمان فضای سیاسی، ناقص‌اند.' },
          ] },
          { t: 'p', x: 'The cities grew very fast, faster than housing or services could follow. The gap between those doing well from the boom and those newly arrived and struggling became visible in a way that was difficult to explain away, and that gap did more to shape what came next than any argument about doctrine.', fa: 'شهرها با سرعتی بسیار زیاد گسترش یافتند؛ سریع‌تر از آن‌که ساخت مسکن و توسعهٔ خدمات بتواند هم‌پای آن پیش برود. شکاف میان کسانی که از رونق اقتصادی بهره می‌بردند و تازه‌واردانی که با دشواری‌های زندگی دست‌وپنجه نرم می‌کردند، به‌وضوح دیده می‌شد و دیگر نمی‌شد به‌سادگی آن را نادیده گرفت. همین شکاف، بیش از هر بحث و جدل عقیدتی، در شکل‌گیری تحولات بعدی نقش داشت.' },
        ] },
        { blocks: [
          { t: 'h', x: 'A cleric in exile', fa: 'روحانی‌ای در تبعید' },
          { t: 'img', key: 'khomeini-exile' },
          { t: 'p', x: 'Ruhollah Khomeini, a senior cleric in Qom, denounced the White Revolution in 1963, objecting in particular to women voting and to land reform touching religious endowments. He was arrested, and his arrest set off large riots in Qom and Tehran.', fa: 'روح‌الله خمینی، از روحانیان بلندپایهٔ قم، در سال ۱۳۴۲ «انقلاب سفید» را محکوم کرد و به‌ویژه با حق رأی زنان و با شمول اصلاحات ارضی نسبت به موقوفات مخالفت کرد. او بازداشت شد و بازداشتش به شورش‌های گسترده‌ای در قم و تهران انجامید.' },
          { t: 'p', x: 'In 1964 he was expelled from the country. That decision is worth pausing on: he could have been imprisoned indefinitely, and instead he was put on a plane.', fa: 'در سال ۱۳۴۳ از کشور تبعید شد. این تصمیم شایستهٔ کمی تأمل است: می‌توانستند او را برای همیشه در زندان نگه دارند، اما به‌جای آن، او را سوار هواپیما کردند و از کشور بیرون فرستادند.' },

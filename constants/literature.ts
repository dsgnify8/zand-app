    ...
    },
    {
      ...
      pages: [
        ...
        { blocks: [
          ...
          { t: 'imgframe', key: 'tomb-ferdowsi', cap: 'The tomb of Ferdowsi at Tus, a place of pilgrimage for lovers of Persian poetry.', capFa: 'آرامگاه فردوسی در توس، زیارتگاه دوستداران شعر فارسی.' },
          { t: 'rule' },
        ] },
        { blocks: [
    ...
    },
    {
      ...
      pages: [
        { blocks: [
          ...
          { t: 'imgframe', key: 'hafez-tomb', cap: 'The Hafezieh in Shiraz, where people come to read rather than to grieve.', capFa: 'حافظیه در شیراز، جایی که مردم برای خواندن می‌آیند، نه برای سوگواری.' },
    ...
    },
    {
      ...
      pages: [
        ...
        { blocks: [
          ...
          { t: 'veil', surface: 'Whoever gives advice to a self willed man is himself in need of advice.', surfaceFa: 'هر که نصیحت خودرای کند، او نصیحت‌گری را محتاج است', hidden: 'Not cynicism. A working rule: you cannot teach someone who has decided they already know, and the effort damages you rather than them. Saadi spent thirty years learning this on the road.', hiddenFa: 'بدبینی نیست؛ یک قاعدهٔ کاربردی است: کسی را که تصمیم گرفته از پیش می‌داند نمی‌توان آموخت، و این تلاش به جای او، به تو آسیب می‌زند. سعدی سی سال در راه همین را آموخت.' },
        ] },
      ],
    },
    {
    ...
    },
    {
      ...
      pages: [
        { blocks: [
          ...
          { t: 'imgframe', key: 'saadi-tomb', cap: 'The Saadieh in Shiraz, where the master of speech is buried.', capFa: 'سعدیه در شیراز، آرامگاه استاد سخن.' },
    ...
    },
    {
      ...
      pages: [
        ...
        { blocks: [
          ...
          { t: 'veil', surface: 'The moving finger writes, and having writ moves on. Nor all your piety nor wit shall lure it back to cancel half a line.', surfaceFa: 'از دی که گذشت هیچ ازو یاد مکن\u200Cفردا که نیامده‌ست فریاد مکن', hidden: 'This is FitzGerald most quoted line, and it is more or less Khayyam. It says the past is closed. Not that it should be accepted, that it is closed, as a matter of fact, the way a proof is closed. It is a mathematician way of describing regret.', hiddenFa: 'این پرنقل‌ترین سطر فیتزجرالد است، و کم‌وبیش همان خیام. می‌گوید گذشته بسته شده است. نه اینکه باید پذیرفتش؛ اینکه بسته شده، همان‌طور که یک برهان بسته می‌شود. این شیوهٔ یک ریاضی‌دان است برای توصیف حسرت.' },
        ] },
        { blocks: [
    ...
    },
    {
      ...
      pages: [
        ...
        { blocks: [
          ...
          { t: 'twotrans', a: { label: 'FITZGERALD, 1859', labelFa: 'فیتزجرالد، ۱۸۵۹', x: 'A Book of Verses underneath the Bough, a Jug of Wine, a Loaf of Bread, and Thou beside me singing in the Wilderness.', fa: 'کتابی شعر زیر شاخه‌ها، سبویی می، نانی، و تو در کنارم که در بیابان آواز می‌خوانی.' }, b: { label: 'WHAT THE PERSIAN SAYS', labelFa: 'آنچه در فارسی آمده', x: 'A loaf of bread, a gourd of wine, a thigh of mutton, and you and I sitting in the wilderness. That is a pleasure beyond any sultan kingdom.', fa: 'گر دست دهد ز مغز گندم نانی، وز می دو منی ز گوسفندی رانی؛ با لاله‌رخی و گوشهٔ بستانی، عیشی بود آن نه حد هر سلطانی.' } },
    ...
    },
    {
      ...
      pages: [
        { blocks: [
          ...
          { t: 'story', title: 'The Question', titleFa: 'آن پرسش', x: 'Who was greater, Shams asked, the Prophet Muhammad or Bayazid Bastami? Rumi answered as any scholar would: the Prophet, without question. Then why, said Shams, did the Prophet say we have not known You as You should be known, while Bayazid said glory be to me, how great is my majesty?', fa: 'شمس پرسید: کدام برتر بود، محمد یا بایزید بسطامی؟ مولانا همان پاسخی را داد که هر عالمی می‌داد: پیامبر، بی‌هیچ تردیدی. شمس گفت: پس چرا پیامبر گفت «ما عرفناک حق معرفتک» — تو را چنان‌که باید نشناختیم — و بایزید گفت «سبحانی ما اعظم شأنی» — پاک و منزهم من، چه بزرگ است مقام من؟', moral: 'Rumi understood, and by some accounts fell to the ground.', moralFa: 'مولانا فهمید، و به روایتی همان‌جا بر زمین افتاد.' },
    ...
    },
    {
      ...
      pages: [
        ...
        { blocks: [
          ...
          { t: 'twotrans', a: { label: 'THE POPULAR ENGLISH', labelFa: 'روایت پرطرفدار انگلیسی', x: 'Out beyond ideas of wrongdoing and rightdoing, there is a field. I will meet you there.', fa: 'آن‌سوی اندیشه‌های بدکرداری و نیک‌کرداری، دشتی هست. آنجا تو را می‌بینم.' }, b: { label: 'WHAT THE PERSIAN SAYS', labelFa: 'آنچه در فارسی آمده', x: 'Beyond belief and unbelief there is a plain. I will meet you there.', fa: 'از کفر و ز اسلام برون صحراییست، ما را به میان آن فضا سوداییست.' } },

  ...
  },
  {
    ...
    pages: [
      ...
      { blocks: [
        ...
        { t: 'p', x: 'The position was a fortune. Every empire that ruled here grew rich on the trade that had nowhere else to go. Silk, spice, and gold crossed Iranian soil, and Iranian hands took their share.', fa: 'این موقعیت به خودی خود، ثروت بود. هر امپراتوری که اینجا حکم راند، از تجارتی که راه دیگری به جز ایران نداشت، توانگر شد. ابریشم و ادویه و طلا از خاک ایران گذشتند و ایرانی‌ها سهم خود را برداشتند.' },
        { t: 'p', x: 'And where water was scarce, Iranians invented their way around it. The qanat, an underground channel tapping mountain groundwater and carrying it for miles beneath the desert, is a Persian invention thousands of years old, and it made cities possible where there was no river at all.', fa: 'و هر جا آب کم بود، ایرانی راهی از دلش بیرون کشید. قنات، کاریزی زیرزمینی که آب کوه را می‌گیرد و فرسنگ‌ها زیر کویر می‌بَرد، اختراعی ایرانی است به قدمت هزاران سال، و آبادیِ شهرهایی را ممکن کرد که هیچ رودی نداشتند.' },
        { t: 'mark', x: 'They could not move the desert, so they ran rivers underneath it.', fa: 'کویر را نمی‌توانستند جابه‌جا کنند؛ پس رود را از زیرش گذراندند.' },
      ] },
      { blocks: [
        { t: 'h', x: 'What the land cost', fa: 'این سرزمین چه هزینه‌ای پرداخت' },
        { t: 'p', x: 'The open east was a wound that never closed. Across the steppe came the Turks, the Mongols, and Timur, and each time the flat northeast offered no wall to stop them. The Mongol invasion, arriving through that open door, was among the greatest catastrophes Iran ever suffered.', fa: 'باز بودنِ مرزهای شرقی زخمی بود که هرگز بسته نشد. از آن سوی دشت‌ها ترکان آمدند، مغولان آمدند، تیمور آمد؛ و هر بار مرزِ هموارِ شمال شرقی دیواری برای بازداشتنشان نداشت. هجوم مغول، که از همان درِ باز رسید، از بزرگ‌ترین فاجعه‌هایی بود که بر ایران گذشت.' },
        { t: 'p', x: 'And in the modern age the same centrality drew a different kind of pressure. Russia to the north and Britain to the south did not want Iran for its soil but for its position, and later for what lay beneath it. A country at the centre of the world is never left alone by the powers of the world.', fa: 'و در دوران جدید، همین مرکزیت فشاری از جنس دیگر آورد. روسیه از شمال و بریتانیا از جنوب، ایران را نه برای خاکش که برای موقعیت جغرافیایی‌اش می‌خواستند، و بعدها برای آنچه زیر خاکش بود. کشوری که در مرکز جهان است، هیچ‌وقت از سوی قدرت‌های جهان به حال خود رها نمی‌شود.' },
        { t: 'p', x: 'The oil found in Khuzestan in the early twentieth century made that truth heavier still. Geography had given Iran the crossroads, and then it gave it the prize.', fa: 'نفتی که اوایل قرن بیستم در خوزستان پیدا شد، این حقیقت را سنگین‌تر کرد. جغرافیا اول چهارراه را به ایران داده بود، بعد جایزه را هم در مرکز همان چهارراه گذاشت.' },
      ] },
    ],
  },
  {

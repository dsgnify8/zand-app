  ...
  },
  {
    ...
    steps: [
      { key: 'possessives', kind: 'lesson', title: 'My, your, his', titleFa: 'ضمیر ملکی',
        sub: 'ketābam instead of ketāb-e man', route: '/learn/lesson?unit=possessives&lesson=possessives',
        unit: 'possessives', lesson: 'possessives' },
      { key: 'plurals', kind: 'lesson', title: 'More than one', titleFa: 'جمع',
        sub: 'One ending does almost all of it', route: '/learn/lesson?unit=possessives&lesson=plurals',
        unit: 'possessives', lesson: 'plurals' },
      { key: 'blanks-7', kind: 'quiz', title: 'Finish the sentence', titleFa: 'جای خالی',
        sub: 'Possessives and plurals in context', route: '/learn/blanks?stage=possessives' },
    ],
  },
  {
    key: 'comparisons',
    ...
    steps: [
      { key: 'comparisons', kind: 'lesson', title: 'Bigger, smaller, best', titleFa: 'مقایسه',
        sub: '-tar, -tarin, and az for than', route: '/learn/lesson?unit=comparisons&lesson=comparisons',
  ...
  },
  {
    ...
    steps: [
      { key: 'work', kind: 'lesson', title: 'Work and the shape of a day', titleFa: 'کار',
        sub: 'Jobs, titles, and sar-e kār', route: '/learn/lesson?unit=work&lesson=work',
        unit: 'work', lesson: 'work' },
      { key: 'cards-8', kind: 'flashcards', title: 'Drill these', titleFa: 'تمرین',
        sub: 'Everything from work', route: '/learn/cards?stage=work' },
    ],
  },
  {
    key: 'shopping',
    ...
    steps: [
      { key: 'shopping', kind: 'lesson', title: 'Buying things', titleFa: 'خرید',
        sub: 'And when bargaining is expected', route: '/learn/lesson?unit=shopping&lesson=shopping',
  ...
  },
  {
    ...
    steps: [
      { key: 'health', kind: 'lesson', title: 'When something hurts', titleFa: 'سلامتی',
        sub: 'saram dard mikonad', route: '/learn/lesson?unit=health&lesson=health',
  ...
  },
  {
    ...
    steps: [
      { key: 'plans', kind: 'lesson', title: 'Making plans', titleFa: 'قرار',
        sub: 'The thing nobody explains about invitations', route: '/learn/lesson?unit=plans&lesson=plans',
  ...
  },
  {
    ...
    steps: [
      { key: 'compounds', kind: 'lesson', title: 'How Persian builds verbs', titleFa: 'فعل مرکب',
        sub: 'kardan, shodan, zadan, dāshtan', route: '/learn/lesson?unit=compounds&lesson=compounds',
        unit: 'compounds', lesson: 'compounds' },
      { key: 'cards-7', kind: 'flashcards', title: 'Drill the compounds', titleFa: 'تمرین',
        sub: 'Every compound from this chapter', route: '/learn/cards?stage=compounds' },
    ],
  },
  {
    key: 'ra',
    ...
    steps: [
      { key: 'ra', kind: 'lesson', title: 'The little word rā', titleFa: 'را',
        sub: 'And why Persian can move its words around', route: '/learn/lesson?unit=ra&lesson=ra',
        unit: 'ra', lesson: 'ra' },
    ],
  },
  {
    ...
    steps: [
      { key: 'ezafe', kind: 'lesson', title: 'Chains of ezāfe', titleFa: 'اضافه',
        sub: 'Read the chain backwards and it opens', route: '/learn/lesson?unit=ezafe&lesson=ezafe',
        unit: 'ezafe', lesson: 'ezafe' },
      { key: 'read-2', kind: 'lesson', title: 'Read something real', titleFa: 'خواندن',
        sub: 'Whole texts, every word one tap away', route: '/learn/read' },
    ],
  },
  {
    key: 'subjunctive',
    ...
    steps: [
      { key: 'subjunctive', kind: 'lesson', title: 'Things that have not happened', titleFa: 'التزامی',
        sub: 'Two verbs, and the second one bends', route: '/learn/lesson?unit=subjunctive&lesson=subjunctive',
  ...
  },
  {
    ...
    steps: [
      { key: 'reported', kind: 'lesson', title: 'Saying what someone said', titleFa: 'نقل قول',
        sub: 'The tense does not shift', route: '/learn/lesson?unit=reported&lesson=reported',

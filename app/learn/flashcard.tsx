...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: fonts.heading, fontSize: fontSize.xl, color: lw.ink, flexShrink: 1 },
  glyph: { fontFamily: fonts.persian, fontSize: fontSize.xxl, color: lw.green },
  progressTrack: { height: 6, borderRadius: radius.pill, backgroundColor: lw.hair, marginTop: spacing.lg, overflow: 'hidden' },
  progressFill: { height: 6, borderRadius: radius.pill, backgroundColor: lw.green },
  counterRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: spacing.sm },
  counter: { fontFamily: fonts.bodyStrong, fontSize: fontSize.xs, letterSpacing: 1, color: lw.muted },
  prevBtn: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  prevDisabled: { opacity: 0.5 },
  prevText: { fontFamily: fonts.bodyStrong, fontSize: fontSize.sm, color: lw.muted },
  prevTextDisabled: { color: lw.hair },
  ...
  front: { backgroundColor: lw.surface, borderWidth: 1, borderColor: lw.hair },
  back: { backgroundColor: lw.green },
  fa: { fontFamily: fonts.persian, fontSize: 60, color: lw.ink, textAlign: 'center' },
  symbol: { fontFamily: fonts.persian, fontSize: 40, color: lw.green, marginTop: spacing.sm },
  backSymbol: { fontFamily: fonts.persian, fontSize: 34, color: 'rgba(255,255,255,0.7)', marginBottom: spacing.sm },
  tapHint: { fontFamily: fonts.body, fontSize: fontSize.sm, color: lw.muted, position: 'absolute', bottom: spacing.lg },
  translit: { fontFamily: fonts.body, fontSize: fontSize.xl, color: 'rgba(255,255,255,0.85)' },
  en: { fontFamily: fonts.heading, fontSize: fontSize.display, color: lw.surface, textAlign: 'center', marginTop: spacing.sm },
  ...
  learningBtn: { backgroundColor: lw.surface, borderWidth: 1, borderColor: lw.hair },
  learningText: { fontFamily: fonts.bodyStrong, fontSize: fontSize.base, color: lw.muted },
  knownBtn: { backgroundColor: lw.green },
  knownText: { fontFamily: fonts.bodyStrong, fontSize: fontSize.base, color: lw.surface },
  ...
  primaryBtn: { backgroundColor: lw.green, borderRadius: radius.pill, paddingVertical: spacing.md, paddingHorizontal: spacing.xl, marginTop: spacing.sm },

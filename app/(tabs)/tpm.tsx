...
const s = StyleSheet.create({
  head: { flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', paddingLeft: spacing.md, paddingRight: spacing.lg, paddingTop: spacing.sm, paddingBottom: spacing.md },
